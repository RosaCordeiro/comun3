...
public subroutine of_registra_tentativa_login (string ps_matricula, string ps_mensagem, boolean pb_sucesso, string ps_autenticacao)
public function string of_get_is_host ()
public function string of_get_is_ip ()
end prototypes
...
If SqlCa.SqlCode = 0 Then
	...
	Choose Case lvs_Id_Situacao
		...
		Case "I"
			This.of_Registra_Tentativa_Login( ps_Nr_Matricula, "Usu$$HEX1$$e100$$ENDHEX$$rio " + Nm_Usuario + " est$$HEX1$$e100$$ENDHEX$$ inativo e n$$HEX1$$e300$$ENDHEX$$o $$HEX1$$e900$$ENDHEX$$ permitido o acesso do mesmo a nenhum sistema ou procedimento.", False, "L" )			
			...
			Return
		Case "B"
			This.of_Registra_Tentativa_Login( ps_Nr_Matricula, "Usu$$HEX1$$e100$$ENDHEX$$rio " + Nm_Usuario + " est$$HEX1$$e100$$ENDHEX$$ bloqueado e n$$HEX1$$e300$$ENDHEX$$o $$HEX1$$e900$$ENDHEX$$ permitido o acesso do mesmo a nenhum sistema ou procedimento.", False, "L" )			
			...
			Return
		Case "F"
			This.of_Registra_Tentativa_Login( ps_Nr_Matricula, "Usu$$HEX1$$e100$$ENDHEX$$rio " + Nm_Usuario + " est$$HEX1$$e100$$ENDHEX$$ afastado e n$$HEX1$$e300$$ENDHEX$$o $$HEX1$$e900$$ENDHEX$$ permitido o acesso do mesmo a nenhum sistema ou procedimento.", False, "L" )			
...
//											"Para alterar a situa$$HEX2$$e700e300$$ENDHEX$$o contate o setor de RH.", Exclamation! )
		...
		Case Else
			This.of_Registra_Tentativa_Login( ps_Nr_Matricula, "Usu$$HEX1$$e100$$ENDHEX$$rio " + Nm_Usuario + " inacess$$HEX1$$ed00$$ENDHEX$$vel e n$$HEX1$$e300$$ENDHEX$$o $$HEX1$$e900$$ENDHEX$$ permitido o acesso do mesmo a nenhum sistema ou procedimento.", False, "L" )	
			ivb_Usuario_Localizado = False
			Return		
	...
	If SqlCa.SqlCode = 100 Or SqlCa.SqlCode = -1 Then			
		...
		/* Perfil de usu$$HEX1$$e100$$ENDHEX$$rio por filial */
		SELECT
			usf.cd_perfil_usuario,
			pu.id_perfil_master
		INTO
			:cd_perfil_usuario,
			:lvs_id_perfil_master
		FROM
			usuario_sistema_filial usf
		INNER JOIN
			perfil_usuario pu
			ON pu.cd_sistema = usf.cd_sistema
			AND pu.cd_perfil_usuario = usf.cd_perfil_usuario
		WHERE
			usf.cd_sistema = :cd_sistema
			AND usf.nr_matricula = :nr_matricula
			AND usf.cd_filial = :gl_cd_filial;
			
		Choose Case SQLCA.SQLCode
			Case -1
				ls_mensagem = "Erro ao tentar logar usu$$HEX1$$e100$$ENDHEX$$rio " + Nm_Usuario + ". Erro: " + SQLCA.SQLErrText
				This.of_Registra_Tentativa_Login( ps_Nr_Matricula, ls_mensagem, False, "L" )
				MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", ls_mensagem, Exclamation!, Ok!)
				ivb_Usuario_Localizado = False	
			Case 0
			...
			Case 100
				...
				Else
					This.of_Registra_Tentativa_Login( ps_Nr_Matricula, "Usu$$HEX1$$e100$$ENDHEX$$rio " + Nm_Usuario + " n$$HEX1$$e300$$ENDHEX$$o possui perfil definido para este sistema.", False, "L" )
	...
	End If
Else
	This.of_Registra_Tentativa_Login( ps_Nr_Matricula, "Usu$$HEX1$$e100$$ENDHEX$$rio com a matr$$HEX1$$ed00$$ENDHEX$$cula " + ps_Nr_Matricula + " n$$HEX1$$e300$$ENDHEX$$o localizado.", False, "L" )
...
If This.cd_Sistema = 'CL' Then
	Open(dc_w_Login_Sistema_paf)
Elseif This.cd_sistema = 'WS' Then
	Open(dc_w_Login_Sistema_wms)
Else
	Open(dc_w_Login_Sistema)
End If

If gvo_Aplicacao.of_Get_App_Usa_Menu( ) Then
	...
	If Trim(as_Procedimento) <> "" Then
		...
		Else
			If Not gvo_Aplicacao.ivo_Seguranca.of_Get_Persiste_Usuario( ) Then
				MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Usu$$HEX1$$e100$$ENDHEX$$rio n$$HEX1$$e300$$ENDHEX$$o tem permiss$$HEX1$$e300$$ENDHEX$$o para acessar este procedimento: " + String(as_Procedimento) , StopSign!)
			Else
				If MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Usu$$HEX1$$e100$$ENDHEX$$rio n$$HEX1$$e300$$ENDHEX$$o tem permiss$$HEX1$$e300$$ENDHEX$$o para acessar este procedimento: "+String(as_Procedimento)+".~r~rDeseja acessar com usu$$HEX1$$e100$$ENDHEX$$rio diferente?", StopSign! , YesNo! ) = 1 Then
					gvo_Aplicacao.ivo_Seguranca.of_Set_Persiste_Usuario( False )
...
lvs_Msg 	= 	"Caro(a) Usu$$HEX1$$e100$$ENDHEX$$rio,<br /><br />~n"+ &
				"Foram esgotadas as tentativas de acesso de login:<br /><br />~n"+ &
				"<b>Matr$$HEX1$$ed00$$ENDHEX$$cula: </b>"+This.nr_matricula+"<br />~n"+ &
				"<b>Nome Usu$$HEX1$$e100$$ENDHEX$$rio: </b>"+This.nm_usuario+"<br />~n"+ &
				"<b>Procedimento: </b>"+IIF(This.of_Get_Ultimo_Procedimento()<>"",This.of_Get_Descricao_Procedimento(False),"LOGIN")+"<br />~n"+ &
				IIF(Not IsNull(lvs_Perfil_Usuario) and lvs_Perfil_Usuario<>"","<b>Perfil Usu$$HEX1$$e100$$ENDHEX$$rio: </b>"+String(Cd_Perfil_Usuario)+" - "+lvs_Perfil_Usuario+"<br />~n","")+ &
				"<b>Data/Hora: </b>"+String(lvdh_Bloqueio,'DD/MM/YYYY HH:MM:SS')+"<br />~n"+ &
				"<b>Filial: </b>"+String(lvl_Filial)+"<br />~n"+ &
				"<b>Host: </b>"+This.of_Get_Host()+"<br />~n"+ &
				"<b>Usu$$HEX1$$e100$$ENDHEX$$rio Windows: </b>"+This.of_Get_Usuario_Windows()+"<br />~n"+ &
				"<b>Sistema: </b>"+This.Cd_sistema+"<br />~n"+ &
				"<b>N$$HEX1$$ba00$$ENDHEX$$ Tentativas: </b>"+String(This.Of_Get_Tentativas_Login(This.Nr_Matricula, 3600))+" tentativa(s) nos $$HEX1$$fa00$$ENDHEX$$ltimos 60 minutos.<br />~n"+ &
				"<b>Bloqueado: </b>"+IIF(lvb_Bloqueia,'SIM','N$$HEX1$$c300$$ENDHEX$$O')+"<br />~n"+ &
...
Where ul.dh_tentativa >= :lvdth_Datahora
 And ul.nr_matricula = :ps_matricula
 And coalesce(ul.id_sucesso,'N') = 'N'
 And ul.dh_tentativa >= coalesce( (select max(ul1.dh_tentativa) 
											from usuario_login ul1 
											 where ul1.nr_matricula = ul.nr_matricula
												and coalesce(ul1.id_sucesso,'N') = 'S'
												and ul1.dh_tentativa >= :lvdth_Datahora), :lvdth_Datahora)
Using SQLCa;
...
//Usuario 999985 - AUTOMACAO TI
//Usado pela infra, nao deve expirar a senha
//Chamado: 1284989
If This.nr_matricula = '999985' Then
	Return False
End If

If This.Cd_Procedimento = "VERIFICA$$HEX2$$c700c300$$ENDHEX$$O DE ACESSO" Then Return False
If Not Parametros_Carregados Then This.Of_Carrega_Parametros( )
...
If IsNull(lvl_Dias_Expirar) Then lvl_Dias_Expirar = 0
...
If Len(Trim(ps_token)) <> 8 then Return False
...
public subroutine of_registra_tentativa_login (string ps_matricula, string ps_mensagem, boolean pb_sucesso, string ps_autenticacao);//ps_autenticacao:		- L = Localiza$$HEX2$$e700e300$$ENDHEX$$o de usu$$HEX1$$e100$$ENDHEX$$rio ou acesso (n$$HEX1$$e300$$ENDHEX$$o vem da tela de login)
//							- B = Login por biometria
//							- D = Login com senha digitada
//							- A = Altera$$HEX2$$e700e300$$ENDHEX$$o de Senha
...
Try
	...
	//Conecta uma segunda transa$$HEX2$$e700e300$$ENDHEX$$o com as mesmas informa$$HEX2$$e700f500$$ENDHEX$$es do SQLCA
	If SQLCA.of_Connect_New_Trans(ref lvtr_Trans) Then
		...
		If Not IsNull(This.nr_matricula) and (Trim(This.nr_matricula)<>"") and (ivb_Usuario_Localizado) and (ps_autenticacao <> "L") Then 	
			ls_Host 		= This.Of_Get_Host()
			ls_IP			= This.Of_Get_IP()
			ll_Filial		= This.Of_Get_Filial()	
			ls_Sucesso	= IIF(pb_sucesso, "S", "N")
			
			insert into usuario_login (nr_matricula, dh_tentativa, de_host, de_ip, cd_filial, cd_sistema, cd_procedimento, id_sucesso, id_forma_autenticacao)
			Values (:This.nr_matricula, getDate(), :ls_Host, :ls_IP, :ll_Filial, :This.Cd_sistema, :This.Cd_Procedimento, :ls_Sucesso, :ps_autenticacao)
			Using lvtr_Trans;
			
			If lvtr_Trans.SQLCode = 0 Then
				lvtr_Trans.Of_Commit()
			Else
	...
	Else
		If gvb_Auto Then	
			gvo_aplicacao.Of_Grava_Log( "N$$HEX1$$e300$$ENDHEX$$o foi poss$$HEX1$$ed00$$ENDHEX$$vel conectar no banco de dados para gravar a tentativa de login.")
		Else
			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o!", "N$$HEX1$$e300$$ENDHEX$$o foi poss$$HEX1$$ed00$$ENDHEX$$vel conectar no banco de dados para gravar a tentativa de login.", Exclamation!)
		End If
	End If
...
Catch (RuntimeError lvo_Erro)
	...
	Else
		gvo_aplicacao.Of_Grava_Log( This.ClassName()+".of_registra_tentativa_login(): Erro "+lvo_Erro.GetMessage())		
	End If
	Return 
	
Finally
	//Disconecta transa$$HEX2$$e700e300$$ENDHEX$$o
...
public function string of_get_is_host ();Return is_Host
end function

public function string of_get_is_ip ();Return is_IP
end function
