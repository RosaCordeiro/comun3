...
type dw_visual from dc_w_sheet`dw_visual within dc_w_2tab_cadastro_selecao_lista_det
end type

type gb_aux_visual from dc_w_sheet`gb_aux_visual within dc_w_2tab_cadastro_selecao_lista_det
end type
...
event ue_habilita_historico();If ivb_grava_log Then This.ivm_Menu.mf_historico( This.RowCount() > 0 )
