HA$PBExportHeader$dc_w_2tab_consulta_selecao_lista_2det.srw
forward
global type dc_w_2tab_consulta_selecao_lista_2det from dc_w_sheet
end type
type tab_1 from tab within dc_w_2tab_consulta_selecao_lista_2det
end type
...
global dc_w_2tab_consulta_selecao_lista_2det dc_w_2tab_consulta_selecao_lista_2det
...
on dc_w_2tab_consulta_selecao_lista_2det.create
int iCurrent
call super::create
...
on dc_w_2tab_consulta_selecao_lista_2det.destroy
call super::destroy
...
event open;call super::open;If IsValid( This ) Then
	...
	Tab_1.TabPage_2.dw_4.ivo_Controle_Menu.of_Recuperar(False)
End If
end event

type dw_visual from dc_w_sheet`dw_visual within dc_w_2tab_consulta_selecao_lista_2det
end type

type gb_aux_visual from dc_w_sheet`gb_aux_visual within dc_w_2tab_consulta_selecao_lista_2det
end type
...
event ue_postretrieve;call super::ue_postretrieve;Boolean lvb_Habilita = False
