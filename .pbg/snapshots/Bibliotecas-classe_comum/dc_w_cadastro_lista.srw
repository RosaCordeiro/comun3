...
If This.wf_informacoes_historico( ref lvs_Tabelas, ref lvs_PK, ref lvs_Chave) Then
	gvo_aplicacao.ivo_historico.of_exibe_log( lvs_Tabelas, "", "")
End If
end event

event resize;call super::resize;gb_1.Height = NewHeight - gb_1.Y - 24
dw_1.Height = gb_1.Height - 120
end event

type dw_visual from dc_w_sheet`dw_visual within dc_w_cadastro_lista
end type

type gb_aux_visual from dc_w_sheet`gb_aux_visual within dc_w_cadastro_lista
end type
...
event ue_reset;call super::ue_reset;This.ivm_Menu.mf_historico( False )
end event
