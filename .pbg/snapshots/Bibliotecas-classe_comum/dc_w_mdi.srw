...
event closequery;call super::closequery;If gvo_Aplicacao.ivo_Seguranca.Cd_Sistema = 'CA' Then
	Integer li_Ret
	String ls_Matricula
	String ls_Nome

	Open(w_ge040_alerta_fechamento_carga)

	li_Ret = Message.DoubleParm

	// N$$HEX1$$e300$$ENDHEX$$o confirmou o fechamento do sistema
	If li_Ret = -1 Then Return 1
		
	If Not gvo_Aplicacao.ivo_Seguranca.of_Libera_Acesso_Procedimento("CA_FECHAMENTO_SISTEMA", ref ls_Matricula) Then Return 1
	...
	Choose Case SqlCa.SqlCode
		Case 0
			gvs_usuario_fechamento = ls_Nome
		Case 100
			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Operador n$$HEX1$$e300$$ENDHEX$$o localizado.")
			Return 1
		Case -1
			SqlCa.of_MsgDbError("Erro ao localizar o nome do operador")
			Return 1
	End Choose
