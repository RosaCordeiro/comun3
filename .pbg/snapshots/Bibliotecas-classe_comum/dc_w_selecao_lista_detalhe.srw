...
type dw_visual from dc_w_sheet`dw_visual within dc_w_selecao_lista_detalhe
end type

type gb_aux_visual from dc_w_sheet`gb_aux_visual within dc_w_selecao_lista_detalhe
end type
