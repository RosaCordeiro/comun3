...
public subroutine wf_set_layout_consulta (string ps_campos)
public function string wf_get_layout_atual ()
end prototypes
...
ElseIf (Pos(ps_dbcampo,'NR_NF') > 0) Then
	pl_width=280
	pl_alinhamento = 1
ElseIf (Pos(ps_dbcampo,'ID_REDE_ECOMMERCE') > 0) Then
	pl_alinhamento = 2
Else
	...
	Choose Case ps_tipo
		...
		Case 'DATE', 'DATETIME'
			...
			If (Pos(ps_dbcampo,'DH_COMPRA') > 0) Then
				pl_width = 480
			ENd if
...
public subroutine wf_set_layout_consulta (string ps_campos);////////////////////////////////////////////////
// 	Seta o layout(colunas) da consulta		 //
////////////////////////////////////////////////
// Os campos ser$$HEX1$$e300$$ENDHEX$$o setados pelo nome, ent$$HEX1$$e300$$ENDHEX$$o 	 //
//	se alterar na tabela, precisar$$HEX1$$e100$$ENDHEX$$ ajustar na //
//	chamada. 											 //
////////////////////////////////////////////////
String lvs_Campo
...
Try
	...
	ps_campos = Upper(ps_campos)
	
	For lvl_Linha = 1 to dw_campos.RowCount()
		lvs_Campo	= Upper(dw_campos.Object.nm_campo[lvl_Linha])
		lvl_Pos		= Pos(ps_campos, lvs_Campo+";")
		If lvl_Pos>0 Then
			dw_campos.Object.id_visivel[lvl_Linha] = "S"
			dw_campos.Object.nr_seq		[lvl_Linha] = lvl_Pos
		Else 
			dw_campos.Object.id_visivel[lvl_Linha] = "N"
		End If
	Next
	
	//Ordena
	dw_campos.SetSort("id_visivel D, nr_seq A")
	dw_campos.Sort()
	
	//Renumera sequencia
	For lvl_Linha = 1 to dw_campos.RowCount()
		dw_campos.Object.nr_seq	[lvl_Linha] = lvl_Linha
	Next
...
public function string wf_get_layout_atual ();////////////////////////////////////////////////
// 	Obtem o layout(colunas) da consulta		 //
////////////////////////////////////////////////
// As colunas ser$$HEX1$$e300$$ENDHEX$$o sepadas por ponto e 		 //
//	virgula.												 //
////////////////////////////////////////////////
String lvs_Campos=""
...
Try
	...
	For lvl_Linha = 1 to dw_campos.RowCount()
		lvs_Campos	+= Upper(dw_campos.Object.nm_campo[lvl_Linha])+";"
	Next
...
//Guarda o layout padr$$HEX1$$e300$$ENDHEX$$o de abertura da tela
ivs_Layout_Padrao = wf_get_layout_atual()
...
If UpperBound(dw_2.ivs_filtro_relatorio) < UpperBound(This.ivs_parametros) Then dw_2.ivs_filtro_relatorio = This.ivs_parametros
...
ivs_SQL = gf_replace(ivs_SQL, 'Where 1=2', 'Where 1=1', 0)
