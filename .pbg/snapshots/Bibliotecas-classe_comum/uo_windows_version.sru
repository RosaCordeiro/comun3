HA$PBExportHeader$uo_windows_version.sru
forward
global type uo_windows_version from nonvisualobject
end type
type osversioninfoex from structure within uo_windows_version
end type
type system_info from structure within uo_windows_version
end type
type langandcodepage from structure within uo_windows_version
end type
type vs_fixedfileinfo from structure within uo_windows_version
end type
end forward
...
global type uo_windows_version from nonvisualobject autoinstantiate
end type
...
public function boolean of_getosversion (ref integer ai_osversion, ref string as_osversion, ref string as_osedition, ref string as_csdversion)
end prototypes
...
public function boolean of_getosversion (ref integer ai_osversion, ref string as_osversion, ref string as_osedition, ref string as_csdversion);// This function gets operating system version information.
...
ai_osversion = lstr_ovi.dwMajorVersion
...
on uo_windows_version.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_windows_version.destroy
