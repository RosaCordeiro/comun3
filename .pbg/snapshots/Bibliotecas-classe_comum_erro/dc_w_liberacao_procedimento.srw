...
Choose Case li_Retorno
	...
	Case 0
		...
		ivo_Seguranca.of_Registra_Tentativa_Login( ivo_Seguranca.Nr_Matricula, 'Digital n$$HEX1$$e300$$ENDHEX$$o localizada no cadastro', False )
...
If gvo_Aplicacao.ivo_Seguranca.of_Get_Persiste_Usuario( ) Then
	...
	If IsValid( This ) Then dw_1.Event ue_Pos( 1, 'de_senha' )
Else
...
If lvs_De_Senha <> "" Then
	...
	If lvs_De_Senha <> ivo_Seguranca.De_Senha Then
		...
		ivi_Tentativas = ivo_Seguranca.Of_Get_Tentativas_Login(ivo_Seguranca.Nr_Matricula, 180) + 1
		...
		If ivi_Tentativas < ivo_Seguranca.Limite_Tentativa_Login Then
			...
			ivo_Seguranca.of_Registra_Tentativa_Login( ivo_Seguranca.Nr_Matricula, 'Senha incorreta', False )
		...
		Else
			//Grava a tentativa de login no banco de dados
			ivo_Seguranca.of_Registra_Tentativa_Login( ivo_Seguranca.Nr_Matricula, 'Limite de tentativas esgotado', False )
	...
	ElseIf Not ivo_seguranca.of_get_senha_expirada(False) Then
		ivo_Seguranca.ivb_Login_Sucesso = True
		ivs_Retorno = ivo_Seguranca.Nr_Matricula
		ivo_Seguranca.of_Registra_Tentativa_Login( ivo_Seguranca.Nr_Matricula, 'Login com Sucesso', True )
		...
		Parent.Event Close( )
	Else
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Sua senha expirou, favor alterar sua senha.~r~rReabra o sistema que ser$$HEX1$$e100$$ENDHEX$$ solicitada a troca de senha.", Exclamation!, Ok!)
		ivo_Seguranca.ivb_Login_Sucesso = False
		ivs_Retorno = "CANCEL"
		Parent.Event Close( )
	End If
Else
	ivo_Seguranca.of_Registra_Tentativa_Login( ivo_Seguranca.Nr_Matricula, 'Senha n$$HEX1$$e300$$ENDHEX$$o informada', False )
