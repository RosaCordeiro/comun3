        ...
        (ll_henv, li_direction, ls_dsn, li_dsnmax, li_dsnlen, &
         ls_desc, li_descmax, li_desclen) = 0
			...
			If (ls_Nova = "Adaptive Server Anywhere")or(Upper(ls_Nova) = "POSTGRESQL UNICODE") Then
				...
				dw_1.Object.Cd_Filial			[lvl_Linha_Nova] = Long( LeftA( ls_dsn, 4 ) )
				dw_1.Object.Nm_Fantasia	[lvl_Linha_Nova] = Upper( MidA( ls_dsn, 6 ) )
...
event dw_1::ue_postretrieve;call super::ue_postretrieve;String lvs_Filtro

dw_2.Accepttext( )

lvs_Filtro = dw_2.Object.de_filtro[1]

If IsNull(lvs_Filtro) or (Trim(lvs_Filtro) = '') Then
	wf_Lista_Odbc()
End If
...
event dw_1::ue_preretrieve;call super::ue_preretrieve;String lvs_Filtro
...
If Trim(lvs_Filtro) <> '' Then
	This.Of_AppendWhere("(cast(cd_filial as varchar(4)) like '"+lvs_Filtro+"%' or "+ &
								 " nm_fantasia like '%"+lvs_Filtro+"%')")
End If
...
event editchanged;call super::editchanged;dw_1.Event ue_Retrieve()
end event
