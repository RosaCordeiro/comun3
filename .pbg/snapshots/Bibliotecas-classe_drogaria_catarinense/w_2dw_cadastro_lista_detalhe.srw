HA$PBExportHeader$w_2dw_cadastro_lista_detalhe.srw
forward
global type w_2dw_cadastro_lista_detalhe from w_sheet
end type
type gb_2 from groupbox within w_2dw_cadastro_lista_detalhe
end type
type gb_1 from groupbox within w_2dw_cadastro_lista_detalhe
end type
type dw_1 from u_dw within w_2dw_cadastro_lista_detalhe
end type
type dw_2 from u_dw within w_2dw_cadastro_lista_detalhe
end type
end forward
...
global w_2dw_cadastro_lista_detalhe w_2dw_cadastro_lista_detalhe
...
event pfc_retrieve;dw_1.Event pfc_Retrieve()
end event

event pfc_addrow;dw_2.Event pfc_AddRow()
end event

on w_2dw_cadastro_lista_detalhe.create
int iCurrent
call super::create
...
on w_2dw_cadastro_lista_detalhe.destroy
call super::destroy
...
// Este evento est$$HEX1$$e100$$ENDHEX$$ programada na classe, pois a maioria das janelas
...
event rowfocuschanging;call super::rowfocuschanging;Integer lvi_Retorno_Salva, &
        lvi_Retorno
...
Choose Case lvi_Retorno_Salva
	Case OK_SEM_PENDENCIAS, &
		...
		If IsValid(ivm_menu_janela) Then
...
event pfc_retrieve;call super::pfc_retrieve;Boolean lvb_Habilita = False
