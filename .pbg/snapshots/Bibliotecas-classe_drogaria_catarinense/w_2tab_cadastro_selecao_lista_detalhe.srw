HA$PBExportHeader$w_2tab_cadastro_selecao_lista_detalhe.srw
forward
global type w_2tab_cadastro_selecao_lista_detalhe from w_sheet
end type
type tab_1 from tab within w_2tab_cadastro_selecao_lista_detalhe
end type
...
global w_2tab_cadastro_selecao_lista_detalhe w_2tab_cadastro_selecao_lista_detalhe
...
event pfc_addrow;// Se o folder ativo for o de sele$$HEX2$$e700e300$$ENDHEX$$o
// indica que a mudan$$HEX1$$e700$$ENDHEX$$a de folder foi via inclus$$HEX1$$e300$$ENDHEX$$o
If Tab_1.SelectedTab = 1 Then
	ivb_AddRow = True
	// Muda para o folder de detalhes
	Tab_1.SelectTab(2)
Else
	ivb_AddRow = False
End If
...
on w_2tab_cadastro_selecao_lista_detalhe.create
int iCurrent
call super::create
...
on w_2tab_cadastro_selecao_lista_detalhe.destroy
call super::destroy
...
Choose Case lvi_Retorno_Salva
	Case OK_SEM_PENDENCIAS, &
		...
		// Permite a inser$$HEX2$$e700e300$$ENDHEX$$o da linha
		This.Reset()
		Return 1
	Case CANCELAR_ERRO_PENDENCIAS, &
		  CANCELAR_ERRO_UPDATE
