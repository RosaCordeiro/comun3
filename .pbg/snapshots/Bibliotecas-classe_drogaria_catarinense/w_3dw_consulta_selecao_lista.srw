HA$PBExportHeader$w_3dw_consulta_selecao_lista.srw
forward
global type w_3dw_consulta_selecao_lista from w_sheet
end type
type dw_1 from u_dw within w_3dw_consulta_selecao_lista
end type
type dw_2 from u_dw within w_3dw_consulta_selecao_lista
end type
type gb_2 from groupbox within w_3dw_consulta_selecao_lista
end type
type gb_1 from groupbox within w_3dw_consulta_selecao_lista
end type
type dw_3 from u_dw within w_3dw_consulta_selecao_lista
end type
end forward
...
global w_3dw_consulta_selecao_lista w_3dw_consulta_selecao_lista
...
event preparar_impressao;Return dw_3.RowCount()
end event

on w_3dw_consulta_selecao_lista.create
int iCurrent
call super::create
...
on w_3dw_consulta_selecao_lista.destroy
call super::destroy
...
IF ISNULL(lvs_where) THEN lvs_where = ""
