HA$PBExportHeader$w_3dw_consulta_selecao_lista_detalhe.srw
forward
global type w_3dw_consulta_selecao_lista_detalhe from w_sheet
end type
type dw_1 from u_dw within w_3dw_consulta_selecao_lista_detalhe
end type
type dw_2 from u_dw within w_3dw_consulta_selecao_lista_detalhe
end type
type dw_3 from u_dw within w_3dw_consulta_selecao_lista_detalhe
end type
type gb_3 from groupbox within w_3dw_consulta_selecao_lista_detalhe
end type
type gb_2 from groupbox within w_3dw_consulta_selecao_lista_detalhe
end type
type gb_1 from groupbox within w_3dw_consulta_selecao_lista_detalhe
end type
end forward
...
global w_3dw_consulta_selecao_lista_detalhe w_3dw_consulta_selecao_lista_detalhe
...
event pfc_retrieve;dw_2.Event pfc_Retrieve()
end event

on w_3dw_consulta_selecao_lista_detalhe.create
int iCurrent
call super::create
...
on w_3dw_consulta_selecao_lista_detalhe.destroy
call super::destroy
