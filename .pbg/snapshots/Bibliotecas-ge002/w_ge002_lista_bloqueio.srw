HA$PBExportHeader$w_ge002_lista_bloqueio.srw
forward
global type w_ge002_lista_bloqueio from dc_w_response_ok_cancela
end type
type st_1 from statictext within w_ge002_lista_bloqueio
end type
end forward
...
global w_ge002_lista_bloqueio w_ge002_lista_bloqueio

type variables
uo_ge002_Parametro_Controle_Bloqueio ivo_Parametro
end variables
...
on w_ge002_lista_bloqueio.create
int iCurrent
call super::create
...
on w_ge002_lista_bloqueio.destroy
call super::destroy
destroy(this.st_1)
end on
...
type gb_1 from dc_w_response_ok_cancela`gb_1 within w_ge002_lista_bloqueio
int Width=1829
int Height=1292
int TabOrder=0
...
type dw_1 from dc_w_response_ok_cancela`dw_1 within w_ge002_lista_bloqueio
int X=46
int Y=56
int Width=1783
int Height=1220
...
string DataObject="dw_ge002_lista_bloqueio"
boolean VScrollBar=true
end type

type cb_ok from dc_w_response_ok_cancela`cb_ok within w_ge002_lista_bloqueio
int X=1088
int Y=1324
int Width=370
int TabOrder=10
...
type cb_cancelar from dc_w_response_ok_cancela`cb_cancelar within w_ge002_lista_bloqueio
int X=1481
int Y=1324
int Width=370
int TabOrder=20
