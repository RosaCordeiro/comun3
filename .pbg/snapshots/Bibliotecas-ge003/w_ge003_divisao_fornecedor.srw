HA$PBExportHeader$w_ge003_divisao_fornecedor.srw
forward
global type w_ge003_divisao_fornecedor from dc_w_response_ok_cancela
end type
end forward

global type w_ge003_divisao_fornecedor from dc_w_response_ok_cancela
integer height = 1372
string title = "GE003 - Divis$$HEX1$$e300$$ENDHEX$$o Fornecedor"
end type
global w_ge003_divisao_fornecedor w_ge003_divisao_fornecedor
...
on w_ge003_divisao_fornecedor.create
call super::create
end on

on w_ge003_divisao_fornecedor.destroy
call super::destroy
end on
...
type pb_help from dc_w_response_ok_cancela`pb_help within w_ge003_divisao_fornecedor
end type

type gb_1 from dc_w_response_ok_cancela`gb_1 within w_ge003_divisao_fornecedor
end type

type dw_1 from dc_w_response_ok_cancela`dw_1 within w_ge003_divisao_fornecedor
integer width = 2299
integer height = 1016
string dataobject = "dw_ge003_divisao_fornecedor"
...
type cb_ok from dc_w_response_ok_cancela`cb_ok within w_ge003_divisao_fornecedor
integer x = 1801
integer y = 1156
end type
...
type cb_cancelar from dc_w_response_ok_cancela`cb_cancelar within w_ge003_divisao_fornecedor
integer x = 2135
integer y = 1156
end type
