HA$PBExportHeader$w_ge005_selecao_conveniado_filial.srw
forward
global type w_ge005_selecao_conveniado_filial from dc_w_selecao_generica
end type
end forward
...
global w_ge005_selecao_conveniado_filial w_ge005_selecao_conveniado_filial

type variables
uo_conveniado ivo_conveniado
end variables

on w_ge005_selecao_conveniado_filial.create
call super::create
end on

on w_ge005_selecao_conveniado_filial.destroy
call super::destroy
end on
...
If lvo_Convenio.Localizado Then
	dw_1.Object.Nm_Convenio	[1] = lvo_Convenio.Nm_Fantasia
	dw_1.Object.Cd_Convenio	[1] = lvo_Convenio.Cd_Convenio
End If
...
type pb_help from dc_w_selecao_generica`pb_help within w_ge005_selecao_conveniado_filial
end type

type gb_2 from dc_w_selecao_generica`gb_2 within w_ge005_selecao_conveniado_filial
integer x = 23
integer y = 360
integer width = 2126
integer height = 1048
...
type gb_1 from dc_w_selecao_generica`gb_1 within w_ge005_selecao_conveniado_filial
integer x = 23
integer y = 4
integer width = 1582
integer height = 344
...
type dw_1 from dc_w_selecao_generica`dw_1 within w_ge005_selecao_conveniado_filial
integer x = 41
integer y = 72
integer width = 1554
integer height = 260
string dataobject = "dw_ge005_selecao_filial"
end type

type dw_2 from dc_w_selecao_generica`dw_2 within w_ge005_selecao_conveniado_filial
integer x = 50
integer y = 408
integer width = 2075
integer height = 980
string dataobject = "dw_ge005_lista_filial"
...
If Trim(lvs_SQL) <> "" Then
	...
	Return 1
Else
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Informe a matr$$HEX1$$ed00$$ENDHEX$$cula ou o nome do conveniado.",StopSign!)
...
type cb_selecionar from dc_w_selecao_generica`cb_selecionar within w_ge005_selecao_conveniado_filial
integer x = 1390
integer y = 1436
end type
...
type cb_cancelar from dc_w_selecao_generica`cb_cancelar within w_ge005_selecao_conveniado_filial
integer x = 1778
integer y = 1436
end type
...
type cb_pesquisar from dc_w_selecao_generica`cb_pesquisar within w_ge005_selecao_conveniado_filial
integer x = 983
integer y = 1436
end type

type st_mensagem from dc_w_selecao_generica`st_mensagem within w_ge005_selecao_conveniado_filial
integer x = 27
integer y = 1448
integer width = 923
long backcolor = 80269524
