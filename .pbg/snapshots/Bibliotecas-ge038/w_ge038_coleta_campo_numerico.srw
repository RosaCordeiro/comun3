HA$PBExportHeader$w_ge038_coleta_campo_numerico.srw
forward
global type w_ge038_coleta_campo_numerico from window
end type
type st_titulo3 from statictext within w_ge038_coleta_campo_numerico
end type
type st_titulo2 from statictext within w_ge038_coleta_campo_numerico
end type
type st_titulo1 from statictext within w_ge038_coleta_campo_numerico
end type
type cb_voltar from commandbutton within w_ge038_coleta_campo_numerico
end type
type dw_1 from datawindow within w_ge038_coleta_campo_numerico
end type
type cb_confirmar from commandbutton within w_ge038_coleta_campo_numerico
end type
type cb_cancelar from commandbutton within w_ge038_coleta_campo_numerico
end type
type gb_1 from groupbox within w_ge038_coleta_campo_numerico
end type
end forward
...
global w_ge038_coleta_campo_numerico w_ge038_coleta_campo_numerico
...
on w_ge038_coleta_campo_numerico.create
...
on w_ge038_coleta_campo_numerico.destroy
