HA$PBExportHeader$uo_icontray.sru
$PBExportComments$Icon System Tray functions
forward
global type uo_icontray from nonvisualobject
end type
type guid from structure within uo_icontray
end type
type notifyicondata from structure within uo_icontray
end type
type dllversioninfo from structure within uo_icontray
end type
type point from structure within uo_icontray
end type
end forward
...
global type uo_icontray from nonvisualobject autoinstantiate
end type
