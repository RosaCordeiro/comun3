HA$PBExportHeader$w_ge077_selecao_dependente_cliente.srw
forward
global type w_ge077_selecao_dependente_cliente from dc_w_selecao_generica
end type
end forward
...
integer width = 3209
integer height = 1612
string title = "GE077 - Sele$$HEX2$$e700e300$$ENDHEX$$o de Dependente de Clientes do Clube"
long backcolor = 80269524
end type
global w_ge077_selecao_dependente_cliente w_ge077_selecao_dependente_cliente

type variables
uo_cliente_central ivo_cliente
end variables

on w_ge077_selecao_dependente_cliente.create
call super::create
end on

on w_ge077_selecao_dependente_cliente.destroy
call super::destroy
end on
...
type pb_help from dc_w_selecao_generica`pb_help within w_ge077_selecao_dependente_cliente
end type

type gb_2 from dc_w_selecao_generica`gb_2 within w_ge077_selecao_dependente_cliente
integer x = 18
integer y = 292
integer width = 3141
integer height = 1076
...
type gb_1 from dc_w_selecao_generica`gb_1 within w_ge077_selecao_dependente_cliente
integer x = 18
integer y = 8
integer width = 2103
integer height = 268
...
type dw_1 from dc_w_selecao_generica`dw_1 within w_ge077_selecao_dependente_cliente
integer x = 41
integer y = 76
integer width = 2071
integer height = 184
string dataobject = "dw_ge077_selecao_dependente"
end type

event dw_1::editchanged;call super::editchanged;dw_2.Reset()
end event

type dw_2 from dc_w_selecao_generica`dw_2 within w_ge077_selecao_dependente_cliente
integer x = 41
integer y = 344
integer width = 3095
integer height = 1004
string dataobject = "dw_ge077_lista_dependente"
...
type cb_selecionar from dc_w_selecao_generica`cb_selecionar within w_ge077_selecao_dependente_cliente
integer x = 2391
integer y = 1396
end type
...
type cb_cancelar from dc_w_selecao_generica`cb_cancelar within w_ge077_selecao_dependente_cliente
integer x = 2789
integer y = 1396
end type
...
type cb_pesquisar from dc_w_selecao_generica`cb_pesquisar within w_ge077_selecao_dependente_cliente
integer x = 1920
integer y = 1396
end type

type st_mensagem from dc_w_selecao_generica`st_mensagem within w_ge077_selecao_dependente_cliente
integer x = 27
integer y = 1408
integer width = 1467
long backcolor = 80269524
