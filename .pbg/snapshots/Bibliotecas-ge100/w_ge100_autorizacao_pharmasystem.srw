HA$PBExportHeader$w_ge100_autorizacao_pharmasystem.srw
forward
global type w_ge100_autorizacao_pharmasystem from dc_w_response
end type
type dw_1 from dc_uo_dw_base within w_ge100_autorizacao_pharmasystem
end type
type gb_1 from groupbox within w_ge100_autorizacao_pharmasystem
end type
type cb_ok from commandbutton within w_ge100_autorizacao_pharmasystem
end type
type st_msg from statictext within w_ge100_autorizacao_pharmasystem
end type
type cb_cancelar from commandbutton within w_ge100_autorizacao_pharmasystem
end type
type cb_complemento from commandbutton within w_ge100_autorizacao_pharmasystem
end type
end forward
...
integer width = 3337
integer height = 1300
string title = "GE084 - Autoriza$$HEX2$$e700e300$$ENDHEX$$o Pharma-System"
...
global w_ge100_autorizacao_pharmasystem w_ge100_autorizacao_pharmasystem
...
on w_ge100_autorizacao_pharmasystem.create
int iCurrent
call super::create
...
on w_ge100_autorizacao_pharmasystem.destroy
call super::destroy
destroy(this.dw_1)
destroy(this.gb_1)
destroy(this.cb_ok)
...
For ll_row = 1 To Sitef.PharmaSystem.ds_Autorizacao.RowCount()
	...
	dw_1.object.cd_produto        [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.cd_produto       [ll_row]
	dw_1.object.nm_produto        [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.nm_produto       [ll_row]
	dw_1.object.de_codigo_barras  [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.de_codigo_barras [ll_row]
	dw_1.object.qt_autorizada     [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.qt_autorizada    [ll_row]
	dw_1.object.qt_vendida        [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.qt_autorizada    [ll_row]
	dw_1.object.vl_preco_bruto    [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.vl_preco_bruto   [ll_row]
	dw_1.object.vl_preco_loja		[ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.vl_preco_loja 	[ll_row]
	dw_1.object.vl_preco_pbm		[ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.vl_preco_pbm		[ll_row]
	dw_1.object.vl_preco_liquido  [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.vl_preco_liquido [ll_row]
	dw_1.object.vl_receber        [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.vl_receber       [ll_row]	
	dw_1.object.pc_desconto_loja  [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.pc_desconto_loja [ll_row]
	dw_1.object.pc_desconto_pbm	[ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.pc_desconto_pbm	[ll_row]
	dw_1.object.id_erro           [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.id_erro          [ll_row]
	dw_1.object.de_msg_retorno    [ll_row] = Sitef.PharmaSystem.ds_Autorizacao.object.de_msg_retorno   [ll_row]
	
	If dw_1.object.id_erro[ll_row] = "00" Then
	
		ldc_Desconto += Sitef.PharmaSystem.ds_Autorizacao.object.vl_desconto[ll_row]
...
string dataobject = "dw_ge084_autorizacao_pharmasystem"
