HA$PBExportHeader$w_ge103_busca_facil_lista_tecnica.srw
forward
global type w_ge103_busca_facil_lista_tecnica from dc_w_response
end type
type gb_4 from groupbox within w_ge103_busca_facil_lista_tecnica
end type
type gb_3 from groupbox within w_ge103_busca_facil_lista_tecnica
end type
type gb_2 from groupbox within w_ge103_busca_facil_lista_tecnica
end type
type gb_1 from groupbox within w_ge103_busca_facil_lista_tecnica
end type
type dw_1 from dc_uo_dw_base within w_ge103_busca_facil_lista_tecnica
end type
type dw_2 from dc_uo_dw_base within w_ge103_busca_facil_lista_tecnica
end type
type dw_3 from dc_uo_dw_base within w_ge103_busca_facil_lista_tecnica
end type
type dw_4 from dc_uo_dw_base within w_ge103_busca_facil_lista_tecnica
end type
end forward
...
global w_ge103_busca_facil_lista_tecnica w_ge103_busca_facil_lista_tecnica

type variables
uo_produto ivo_produto

long il_produto, il_Filial
...
public function boolean wf_verifica_filial_sistema_java (long al_filial, ref string as_filial_sistema_java)
...
String as_Filial_Sistema_Java = 'N', lvs_Erro
...
Try
	...
	If not wf_Conecta_Banco_Filial(il_Filial, lvo_Odbc, ref  Transact_Saldo, Ref  as_Filial_Sistema_Java, Ref lvs_Erro) Then
		gvo_Aplicacao.of_Grava_Log("Erro Conex$$HEX1$$e300$$ENDHEX$$o '" + "' " + lvs_Erro)
	End If

	select coalesce(sum(qt_saldo_atual - qt_reserva), 0) 
		into :lvl_Saldo 
		from legado.vw_saldo_estoque
		where cd_filial = :il_Filial and cd_produto = :pl_produto
...
public function boolean wf_verifica_filial_sistema_java (long al_filial, ref string as_filial_sistema_java);select coalesce(id_sistema_novo, 'N')
into :as_Filial_sistema_Java
from filial
...
Choose Case SqlCa.SqlCode
	Case 0
		Return True
	Case 100
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "N$$HEX1$$e300$$ENDHEX$$o foi localizado a filial "+String(al_Filial)+".", Information!)
		Return False
	Case -1
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro na localiza$$HEX2$$e700e300$$ENDHEX$$o da filial "+String(al_Filial)+ "." + SqlCa.SqlErrText, Information!)		
		Return False		
End Choose
...
on w_ge103_busca_facil_lista_tecnica.create
int iCurrent
call super::create
...
on w_ge103_busca_facil_lista_tecnica.destroy
call super::destroy
destroy(this.gb_4)
destroy(this.gb_3)
destroy(this.gb_2)
...
il_Produto	= Long(Mid(ls_Parametro, 5))
...
type pb_help from dc_w_response`pb_help within w_ge103_busca_facil_lista_tecnica
integer x = 91
integer y = 164
end type
...
string dataobject = "dw_ge103_produtos_busca_facil_lista"
