HA$PBExportHeader$w_ge112_leitura_cartao.srw
forward
global type w_ge112_leitura_cartao from window
end type
type st_msg from statictext within w_ge112_leitura_cartao
end type
type rb_magnetico from radiobutton within w_ge112_leitura_cartao
end type
type rb_digitado from radiobutton within w_ge112_leitura_cartao
end type
type st_titulo from statictext within w_ge112_leitura_cartao
end type
type em_cartao from editmask within w_ge112_leitura_cartao
end type
type cb_confirmar from commandbutton within w_ge112_leitura_cartao
end type
type cb_cancelar from commandbutton within w_ge112_leitura_cartao
end type
type gb_1 from groupbox within w_ge112_leitura_cartao
end type
end forward
...
global w_ge112_leitura_cartao w_ge112_leitura_cartao
...
on w_ge112_leitura_cartao.create
...
on w_ge112_leitura_cartao.destroy
destroy(this.st_msg)
...
If This.Checked Then
   ...
   If uo_sitef_retaguarda.of_Leitura_Cartao() Then
		
		//Limpa Digita$$HEX2$$e700e300$$ENDHEX$$o
		em_cartao.Text = LeftA(uo_sitef_retaguarda.de_Cartao_Trilha2,PosA(uo_sitef_retaguarda.de_Cartao_Trilha2,'=')-1)
...
event clicked;
uo_sitef_retaguarda.of_Cancela_Pinpad()
...
If rb_Digitado.Checked Then
	uo_sitef_retaguarda.id_Cartao_Digitado = True
	uo_sitef_retaguarda.de_Cartao_Digitado = Trim(ls_Campo)
End If	
...
event clicked;uo_sitef_retaguarda.of_Cancela_Pinpad()
