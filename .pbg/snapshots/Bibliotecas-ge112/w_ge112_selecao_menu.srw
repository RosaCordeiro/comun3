HA$PBExportHeader$w_ge112_selecao_menu.srw
forward
global type w_ge112_selecao_menu from window
end type
type cb_voltar from commandbutton within w_ge112_selecao_menu
end type
type cb_confirmar from commandbutton within w_ge112_selecao_menu
end type
type cb_cancelar from commandbutton within w_ge112_selecao_menu
end type
type dw_1 from datawindow within w_ge112_selecao_menu
end type
type gb_1 from groupbox within w_ge112_selecao_menu
end type
end forward
...
global w_ge112_selecao_menu w_ge112_selecao_menu
...
If dw_1.RowCount() = 0 Then
	...
	MessageBox("uo_sitef_retaguarda","Nenhuma op$$HEX2$$e700e300$$ENDHEX$$o dispon$$HEX1$$ed00$$ENDHEX$$vel para sele$$HEX2$$e700e300$$ENDHEX$$o",Exclamation!)
Else
...
on w_ge112_selecao_menu.create
...
on w_ge112_selecao_menu.destroy
...
If dw_1.GetRow() = 0 Then
	MessageBox("uo_sitef_retaguarda","Selecione uma op$$HEX2$$e700e300$$ENDHEX$$o.",Exclamation!)
	Return
End If	
...
integer height = 984
integer taborder = 10
string dataobject = "dw_ge112_selecao_menu"
