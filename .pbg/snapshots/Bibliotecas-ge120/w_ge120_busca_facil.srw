HA$PBExportHeader$w_ge120_busca_facil.srw
forward
global type w_ge120_busca_facil from dc_w_response
end type
type gb_1 from groupbox within w_ge120_busca_facil
end type
type dw_1 from dc_uo_dw_base within w_ge120_busca_facil
end type
end forward
...
integer width = 1829
integer height = 1256
string title = "GE120 - Busca F$$HEX1$$e100$$ENDHEX$$cil"
long backcolor = 80269524
gb_1 gb_1
dw_1 dw_1
end type
global w_ge120_busca_facil w_ge120_busca_facil
...
on w_ge120_busca_facil.destroy
call super::destroy
destroy(this.gb_1)
destroy(this.dw_1)
end on
...
If ivo_Produto.Localizado Then
	...
	If ( IsNull( ivo_Produto.id_apresentacao ) Or ivo_Produto.id_apresentacao = "00" Or Trim(ivo_Produto.id_apresentacao) = '' ) OR ( IsNull(ivo_Produto.qt_concentracao) Or ivo_Produto.qt_concentracao = 0 ) Then
		...
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Cadastro do Tipo Apresenta$$HEX2$$e700e300$$ENDHEX$$o ou Concentra$$HEX2$$e700e300$$ENDHEX$$o(mg) n$$HEX1$$e300$$ENDHEX$$o localizado para realizar a fun$$HEX2$$e700e300$$ENDHEX$$o: 'BUSCA F$$HEX1$$c100$$ENDHEX$$CIL'.")
...
type pb_help from dc_w_response`pb_help within w_ge120_busca_facil
integer y = 1044
end type
...
string dataobject = "dw_ge120_produtos_busca_facil"
...
If lvl_Linhas > 0 Then
	...
	For lvl_Linha = 1 To lvl_Linhas
		...
		If ivo_Produto.Localizado Then
			...
			If lvl_Linha = 1 Then
				dw_1.Object.st_Concentracao.text = wf_Concentracao()
			End If
			...
			*/
			...
			This.Object.Pc_Desconto_SOS[lvl_linha] = lvdc_Desconto_SOS
