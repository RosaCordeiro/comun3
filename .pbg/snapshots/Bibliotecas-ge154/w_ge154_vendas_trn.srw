HA$PBExportHeader$w_ge154_vendas_trn.srw
forward
global type w_ge154_vendas_trn from dc_w_selecao_lista_relatorio
end type
end forward

global type w_ge154_vendas_trn from dc_w_selecao_lista_relatorio
string tag = "w_ge154_vendas_trn"
integer width = 4210
integer height = 2048
string title = "GE154 - Vendas TRNCentre por Produto"
end type
global w_ge154_vendas_trn w_ge154_vendas_trn
...
public subroutine wf_insere_default ();/* Conv$$HEX1$$ea00$$ENDHEX$$nio TRNCentre */
...
idwc_Child.SetItem(1, "cd_convenio", 52568)
idwc_Child.SetItem(1, "id_pharmasystem", 'N')
idwc_Child.SetFilter("cd_convenio=52568 and id_pharmasystem='N'")
idwc_Child.Filter()
...
on w_ge154_vendas_trn.create
call super::create
end on

on w_ge154_vendas_trn.destroy
call super::destroy
...
ivds_desconto.of_changedataobject('ds_ge154_desconto_produto')

ivds_devolucao = Create dc_uo_ds_base
ivds_devolucao.of_changedataobject('ds_ge154_devolucao')

ivds_programa = Create dc_uo_ds_base
ivds_programa.of_changedataobject('ds_ge154_programa_pbm')
...
type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge154_vendas_trn
integer y = 1232
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge154_vendas_trn
integer y = 1160
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge154_vendas_trn
integer y = 444
integer width = 4110
integer height = 1408
end type

type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge154_vendas_trn
integer width = 4114
integer height = 420
end type

type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge154_vendas_trn
integer width = 4050
integer height = 332
string dataobject = "dw_ge154_selecao"
end type
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge154_vendas_trn
integer y = 524
integer width = 4041
integer height = 1308
string dataobject = "dw_ge154_lista"
...
If lvdt_Inicio <= Date('31/10/2014') Then
	This.of_appendwhere("k.cd_convenio_pbm <> 'PharmaSystem'")
	ivds_devolucao.of_appendwhere("k.cd_convenio_pbm <> 'PharmaSystem'")
End If
...
Try
	...
	If pl_Linhas > 0 Then
		...
		w_aguarde.Title = 'Atualizando dados melhor venda...'
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge154_vendas_trn
integer x = 2715
integer y = 36
integer height = 220
end type
