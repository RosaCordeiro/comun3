HA$PBExportHeader$w_ge162_consulta_produto_distribuidora.srw
forward
global type w_ge162_consulta_produto_distribuidora from dc_w_sheet
end type
type gb_2 from groupbox within w_ge162_consulta_produto_distribuidora
end type
type gb_1 from groupbox within w_ge162_consulta_produto_distribuidora
end type
type dw_1 from dc_uo_dw_base within w_ge162_consulta_produto_distribuidora
end type
type dw_2 from dc_uo_dw_base within w_ge162_consulta_produto_distribuidora
end type
type dw_3 from dc_uo_dw_base within w_ge162_consulta_produto_distribuidora
end type
type st_1 from statictext within w_ge162_consulta_produto_distribuidora
end type
type st_2 from statictext within w_ge162_consulta_produto_distribuidora
end type
end forward

global type w_ge162_consulta_produto_distribuidora from dc_w_sheet
string tag = "w_ge162_consulta_produto_distribuidora"
string accessiblename = "Cadastro de Produto por Distribuidora (GE162)"
integer width = 5783
integer height = 2100
string title = "GE162 - Consulta de Produtos por Distribuidora"
...
global w_ge162_consulta_produto_distribuidora w_ge162_consulta_produto_distribuidora
...
If   (ls_Situacao = 'P')  Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O produto possui pend$$HEX1$$ea00$$ENDHEX$$ncias fiscais.~r~rSolicite a revis$$HEX1$$e300$$ENDHEX$$o ao Departamento Fiscal.", Exclamation!) 
	Return False
End If

If   (ls_Situacao = 'C')  Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O produto possui pend$$HEX1$$ea00$$ENDHEX$$ncias.~r~rSolicite a revis$$HEX1$$e300$$ENDHEX$$o ao Departamento Gest$$HEX1$$e300$$ENDHEX$$o Estoque.", Exclamation!) 
	Return False
End If
...
on w_ge162_consulta_produto_distribuidora.create
int iCurrent
call super::create
...
on w_ge162_consulta_produto_distribuidora.destroy
call super::destroy
...
If Trim(lvs_Parametro) <> "" Then
	is_Uf = MidA(lvs_Parametro, 1, 2)
	lvs_Parametro = MidA(lvs_Parametro, 3)
...
type dw_visual from dc_w_sheet`dw_visual within w_ge162_consulta_produto_distribuidora
end type

type gb_aux_visual from dc_w_sheet`gb_aux_visual within w_ge162_consulta_produto_distribuidora
end type
...
event itemchanged;call super::itemchanged;Long ll_Produto, lvl_Linha
lvl_Linha=GetRow()

ll_Produto= This.Object.cd_produto[lvl_Linha]

If This.GetColumnName() ='id_situacao' and Data = 'A'  Then
...
For lvl_Linha = 1 To This.RowCount()
	...
	If lvs_Situacao_Nova <> "A" and lvs_Situacao_Nova <> "I" and lvs_Situacao_Nova <> "P" and lvs_Situacao_Nova <> "B" and lvs_Situacao_Nova <> "D" Then
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "A situa$$HEX2$$e700e300$$ENDHEX$$o deve ser A - (Ativo) ou I - (Inativo) ou P - (Pendente) ou D $$HEX1$$1320$$ENDHEX$$ (Bloqueado Cadastral) ~rB - (Bloqueado).")
		This.Event ue_Pos(lvl_Linha, "id_situacao")
		Return -1		
	End If
...
event ue_recuperar;// chamado 	902727-7 - faz override do script ancestor para poder chamar o retrieve aqui, para passar como parametro 
