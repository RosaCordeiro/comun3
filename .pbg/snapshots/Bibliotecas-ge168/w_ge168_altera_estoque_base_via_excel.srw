HA$PBExportHeader$w_ge168_altera_estoque_base_via_excel.srw
forward
global type w_ge168_altera_estoque_base_via_excel from dc_w_response_ok_cancela
end type
type cb_selecionar from commandbutton within w_ge168_altera_estoque_base_via_excel
end type
end forward
...
integer width = 2350
integer height = 840
string title = "GE168 - Atualiza$$HEX2$$e700e300$$ENDHEX$$o do Estoque Base via Excel"
long backcolor = 80269524
cb_selecionar cb_selecionar
end type
global w_ge168_altera_estoque_base_via_excel w_ge168_altera_estoque_base_via_excel
...
public function boolean wf_localiza_produto (long al_produto, ref string as_grupo)
end prototypes
...
If ( lvo_Excel.uo_Referencia_Objeto_Excel(lvs_Arquivo) ) Then
	...
	If Not gf_filial_administrada_sap(dw_1.Object.Cd_Filial[1], Ref ls_Parametro) Then
		lvb_Sucesso = False
		Return lvb_Sucesso
	End If
	...
	If lvl_Linhas > 0 Then
		...
		For lvl_Linha = 1 To lvl_Linhas
			...
			If Not wf_Localiza_Produto(lvl_Produto, Ref ls_Grupo) Then
				lvb_Sucesso = False
				Exit
			End If
			
			// Verifica se Produto $$HEX1$$e900$$ENDHEX$$ Vacina e Se esta Liberado para Filial
			If Not gf_parametro_filial_vacina(ivl_Filial, lvl_Produto) Then 
				lvb_Sucesso = False				
				Exit
			End If 
			...
			If (ls_Parametro = "S" And ls_Grupo = "5") Or ls_Parametro = "N" Then
				If Not wf_Atualiza_Estoque_Base(ivl_Filial,lvl_Produto, lvl_Estoque_Base) Then
					lvb_Sucesso = False
					Exit
				End If
			Else
				MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Filial selecionada $$HEX1$$e900$$ENDHEX$$ administrada pelo SAP.~r$$HEX1$$c900$$ENDHEX$$ permitida a altera$$HEX2$$e700e300$$ENDHEX$$o apenas para produtos de ALMOXARIFADO."+ &
												"~rO produto " + String(lvl_Produto) + " dever$$HEX1$$e100$$ENDHEX$$ ser alterado pelo SAP.", Exclamation!)
				lvb_Sucesso = False
				Exit
			End If
	...
	If lvl_Linhas > 0 Then
		...
		For lvl_Linha = 1 To lvl_Linhas
			...
			If (ls_Parametro = "S" And ls_Grupo = "5") Or ls_Parametro = "N" Then
				...
				End If
			Else				
				MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Filial " + String(lvl_Filial) + " $$HEX1$$e900$$ENDHEX$$ administrada pelo SAP.~r$$HEX1$$c900$$ENDHEX$$ permitida a altera$$HEX2$$e700e300$$ENDHEX$$o apenas para produtos de ALMOXARIFADO." + &
												"~rO produto " + String(lvl_Produto) + " dever$$HEX1$$e100$$ENDHEX$$ ser alterado pelo SAP.", Exclamation!)
				lvb_Sucesso = False
				Exit
...
public function boolean wf_localiza_produto (long al_produto, ref string as_grupo);Long lvl_Produto
...
on w_ge168_altera_estoque_base_via_excel.create
int iCurrent
call super::create
...
on w_ge168_altera_estoque_base_via_excel.destroy
call super::destroy
...
type pb_help from dc_w_response_ok_cancela`pb_help within w_ge168_altera_estoque_base_via_excel
integer x = 37
integer y = 16
end type

type gb_1 from dc_w_response_ok_cancela`gb_1 within w_ge168_altera_estoque_base_via_excel
integer width = 2277
integer height = 612
end type

type dw_1 from dc_w_response_ok_cancela`dw_1 within w_ge168_altera_estoque_base_via_excel
integer x = 46
integer y = 56
integer width = 2245
integer height = 540
integer taborder = 50
string dataobject = "dw_ge168_selecao_arquivo"
end type
...
type cb_ok from dc_w_response_ok_cancela`cb_ok within w_ge168_altera_estoque_base_via_excel
integer x = 1623
integer y = 632
integer width = 325
...
If MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", lvs_MSG2, Question!, YesNo!, 1) = 1 Then
	If wf_Importa() Then
		If ivs_Varias_Filiais = "S" Then
			If is_Filias_Nao_Atualizadas <> "" Then
				lvs_MSG = "Para a altera$$HEX2$$e700e300$$ENDHEX$$o das filiais "+is_Filias_Nao_Atualizadas+" deve ser utilizada o SAP.~rAs demais filiais formam atualizadas com sucesso."
			Else
...
type cb_cancelar from dc_w_response_ok_cancela`cb_cancelar within w_ge168_altera_estoque_base_via_excel
integer x = 1979
integer y = 632
integer width = 325
end type
