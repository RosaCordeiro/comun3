HA$PBExportHeader$dc_uo_nfe_old.sru
forward
global type dc_uo_nfe_old from nonvisualobject
end type
end forward

global type dc_uo_nfe_old from nonvisualobject
end type
global dc_uo_nfe_old dc_uo_nfe_old
...
public function boolean of_gera_chave_acesso (long pl_filial, long pl_nota, string ps_especie, string ps_serie, ref string ps_chave)
...
public function boolean of_grava_chave_acesso (long al_filial, long al_nota, string as_especie, string as_serie, ref string as_chave, string as_tipo_nota)
...
public function boolean of_gera_chave_acesso (long pl_filial, long pl_nota, string ps_especie, string ps_serie, ref string ps_chave);String lvs_CGC,&
	   lvs_Codigo_UF,&
	   lvs_Chave,&
	   lvs_Emissao,&
	   lvs_DV
...
// Desenvolvimento
//ps_Chave = '42100984683481000177550040000002451000000017'
...
public function boolean of_grava_chave_acesso (long al_filial, long al_nota, string as_especie, string as_serie, ref string as_chave, string as_tipo_nota);// Se a chave for passada no par$$HEX1$$e200$$ENDHEX$$metro o sistema vai gerar uma nova chave, pois
// todo envio ao sefaz com sucesso ou n$$HEX1$$e300$$ENDHEX$$o a chave n$$HEX1$$e300$$ENDHEX$$o pode ser repetida

If Not This.of_Gera_Chave_Acesso(al_Filial, al_Nota, as_Especie, as_Serie, ref as_Chave) Then
	Return False
End If
...
on dc_uo_nfe_old.create
call super::create
TriggerEvent( this, "constructor" )
end on

on dc_uo_nfe_old.destroy
