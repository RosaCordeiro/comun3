HA$PBExportHeader$uo_grupo_alteracao_preco.sru
forward
global type uo_grupo_alteracao_preco from nonvisualobject
end type
end forward

global type uo_grupo_alteracao_preco from nonvisualobject
end type
global uo_grupo_alteracao_preco uo_grupo_alteracao_preco
...
OpenWithParm(w_ge109_selecao_grupo_alteracao_preco, This)
...
on uo_grupo_alteracao_preco.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_grupo_alteracao_preco.destroy
