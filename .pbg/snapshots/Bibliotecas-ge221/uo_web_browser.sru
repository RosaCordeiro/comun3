HA$PBExportHeader$uo_web_browser.sru
forward
...
Boolean NavigateComplete = False
...
public function string of_getinnerhtml ()
public function string of_getouterhtml ()
end prototypes

event downloadcomplete();//Seta propriedade de download como concluido
DownloadComplete = True
end event

event documentcomplete(oleobject pdisp, any url);String lvs_URL

//Seta fim de carregamento da p$$HEX1$$e100$$ENDHEX$$gina
NavigateComplete = True

lvs_URL = This.of_geturl()
If Upper(Mid(lvs_URL, Len(lvs_URL) - 3)) <> ".PDF" Then
	//Seta Inner HTML Source a v$$HEX1$$e100$$ENDHEX$$riavel
	InnerHTML = of_getInnerHTML()
	//Seta Outer HTML Source a v$$HEX1$$e100$$ENDHEX$$riavel
	OuterHTML = of_getOuterHTML()
End If
end event

public subroutine of_goback ();// Volta a p$$HEX1$$e100$$ENDHEX$$gina anterior
this.object.goBack()

end subroutine

public subroutine of_goforward ();// Avan$$HEX1$$e700$$ENDHEX$$a a p$$HEX1$$e100$$ENDHEX$$gina seguinte
this.object.goForward()

end subroutine

public subroutine of_gohome ();// Vai para a P$$HEX1$$e100$$ENDHEX$$gina Inicial
this.object.goHome()

end subroutine

public subroutine of_refresh ();// Atualiza p$$HEX1$$e100$$ENDHEX$$gina
this.object.Refresh()

end subroutine

public subroutine of_gosearch ();// Vai para a p$$HEX1$$e100$$ENDHEX$$gina de pesquisa
this.object.goSearch()

end subroutine

public subroutine of_stop ();// Para a navega$$HEX2$$e700e300$$ENDHEX$$o atual
this.object.Stop()

end subroutine

public subroutine of_execwb (integer command_id, integer execution_option);// executar o comando navegador
this.object.ExecWB(command_id, execution_option, AsStatement!)

end subroutine

public subroutine of_navigate (string as_url);// Vai para a URL especificada
...
this.object.Navigate(as_url)

Do While not NavigateComplete
	Yield()
	This.Setredraw(True)
Loop
end subroutine

public subroutine of_execwb_saveas ();// Abrir Config. Salvamento
//this.of_execwb(OLECMDID_SAVEAS, OLECMDEXECOPT_DODEFAULT)
this.of_execwb(OLECMDID_SAVEAS, OLECMDEXECOPT_PROMPTUSER)

end subroutine

public subroutine of_execwb_save ();// Salva o Documento
this.of_execwb(OLECMDID_SAVE, OLECMDEXECOPT_DODEFAULT)

end subroutine

public subroutine of_execwb_print (boolean ab_prompt);// Abrir Config. Impressora
If ab_prompt Then
...
public subroutine of_resize (integer ai_newwidth, integer ai_newheight);// Redimenciona Tela
this.Resize(ai_newwidth, ai_newheight)

// Ajustar p$$HEX1$$e100$$ENDHEX$$gina proporcional ao novo tamanho
...
public subroutine of_designmode ();// ativar o modo de design
this.Object.Document.designMode = "On"

end subroutine

public subroutine of_controlpanel (string as_control_app);// Esta fun$$HEX2$$e700e300$$ENDHEX$$o abre o painel de controle
...
public function string of_getsource ();// Retorna o HTML Source da p$$HEX1$$e100$$ENDHEX$$gina
Return this.Object.Document.documentElement.InnerHTML

end function

public function string of_geturl ();// Retorna a URL Atual
Return this.Object.LocationURL

end function

public subroutine of_setsource (string as_source);// Setar um novo HTML Source a p$$HEX1$$e100$$ENDHEX$$gina
...
public subroutine of_execwb_printpreview ();// Abrir Visualiza$$HEX2$$e700e300$$ENDHEX$$o de impress$$HEX1$$e300$$ENDHEX$$o
this.of_execwb(OLECMDID_PRINTPREVIEW, OLECMDEXECOPT_PROMPTUSER)

end subroutine

public subroutine of_execwb_pagesetup ();// Abrir p$$HEX1$$e100$$ENDHEX$$gina de configura$$HEX2$$e700e300$$ENDHEX$$o
this.of_execwb(OLECMDID_PAGESETUP, OLECMDEXECOPT_PROMPTUSER)

end subroutine

public subroutine of_documentcommand (string as_command);// Executar um comando do documento
...
public subroutine of_documentcommand (string as_command, boolean ab_userinterface);// Executa o comando documento com escolha de pop-up / nopopup
...
public subroutine of_toggle_property (string as_propname);// Alternar uma propriedade, como it$$HEX1$$e100$$ENDHEX$$lico, negrito ou sublinhado

// Esta $$HEX1$$e900$$ENDHEX$$ realmente feito como um comando
of_DocumentCommand(as_PropName)

end subroutine

public function boolean of_ispropertyset (string as_propname);// Consultar uma propriedade booleana do documento, por exemplo, Negrito, it$$HEX1$$e100$$ENDHEX$$lico ou sublinhado

Return this.Object.Document.queryCommandState(as_PropName)

end function

public subroutine of_inserthtml (string as_html);// Insere um HTML dentro de regi$$HEX1$$e300$$ENDHEX$$o selecionada
...
public subroutine of_documentcommand (string as_command, string as_value);// Executa um comando com valor
...
public function integer of_writefile (string as_filename, string as_filecontents);// -----------------------------------------------------------------------------
// SCRIPT:     uo_web_browser.of_WriteFile
//
...
public function unsignedlong of_readfile (string as_filename, ref string as_filecontents);// -----------------------------------------------------------------------------
// SCRIPT:     uo_web_browser.of_ReadFile
//
...
public subroutine of_execscript (integer as_script);// executar um script no documento
this.Object.Document.ParentWindow.ExecScript(as_script)

end subroutine

public function string of_getinnerhtml ();// Retorna o Inner Code da p$$HEX1$$e100$$ENDHEX$$gina ativa
oleobject ole_2
string ls_string

ole_2 = This.object.Document
ls_string = ole_2.body.innerhtml

Return ls_string
end function

public function string of_getouterhtml ();// Retorna o Outer Code da p$$HEX1$$e100$$ENDHEX$$gina ativa
oleobject ole_2
string ls_string
...

