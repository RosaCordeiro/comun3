HA$PBExportHeader$w_ge245_horario_colaboradores.srw
forward
global type w_ge245_horario_colaboradores from dc_w_selecao_lista_relatorio
end type
type cb_1 from commandbutton within w_ge245_horario_colaboradores
end type
type cb_marcar from commandbutton within w_ge245_horario_colaboradores
end type
type cb_2 from commandbutton within w_ge245_horario_colaboradores
end type
end forward
...
integer width = 1819
integer height = 2060
string title = "GE245 - Relat$$HEX1$$f300$$ENDHEX$$rio de Hor$$HEX1$$e100$$ENDHEX$$rio de Trabalho dos Colaboradores"
long backcolor = 80269524
cb_1 cb_1
cb_marcar cb_marcar
cb_2 cb_2
end type
global w_ge245_horario_colaboradores w_ge245_horario_colaboradores

type variables
dc_uo_transacao io_Rubi
...
on w_ge245_horario_colaboradores.create
int iCurrent
call super::create
...
on w_ge245_horario_colaboradores.destroy
call super::destroy
...
event close;call super::close;io_Rubi.of_Disconnect()
Destroy io_Rubi
Destroy io_Filiais
end event

event open;call super::open;io_Rubi = Create dc_uo_transacao

io_Filiais = Create uo_ge216_filiais

io_Rubi.ivs_DataBase = "ORACLE_RH"
io_Rubi.of_Connect("vetorh_ti","RH")
end event

event ue_postopen;call super::ue_postopen;dw_3.of_SetTransObject(io_rubi)
end event

type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge245_horario_colaboradores
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge245_horario_colaboradores
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge245_horario_colaboradores
integer y = 256
integer width = 1719
integer height = 1492
integer weight = 700
...
type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge245_horario_colaboradores
integer width = 1065
integer height = 224
integer weight = 700
end type

type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge245_horario_colaboradores
integer x = 64
integer y = 100
integer width = 1015
integer height = 88
integer taborder = 40
string dataobject = "dw_ge245_selecao"
end type
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge245_horario_colaboradores
...
integer height = 1400
integer taborder = 50
string dataobject = "dw_ge245_lista_filiais"
end type
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge245_horario_colaboradores
integer x = 978
integer y = 1248
integer height = 304
integer taborder = 60
string dataobject = "dw_ge245_relatorio"
end type
...
dw_3.of_ChangeDataObject('dw_ge245_relatorio')
dw_3.of_SetTransObject(io_Rubi)
...
/*			Declare sp_quadro procedure For sp_monta_quadro_horarios
			...
			Choose Case io_Rubi.SqlCode
				Case -1
					io_Rubi.of_MsgDbError()
					Exit
			End Choose
