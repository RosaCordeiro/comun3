HA$PBExportHeader$w_ge283_rentabilidade_produto_gerencial.srw
forward
global type w_ge283_rentabilidade_produto_gerencial from dc_w_selecao_lista_relatorio
end type
type pb_info from picturebutton within w_ge283_rentabilidade_produto_gerencial
end type
end forward

global type w_ge283_rentabilidade_produto_gerencial from dc_w_selecao_lista_relatorio
string tag = "w_ge283_rentabilidade_produto_gerencial"
integer width = 3657
integer height = 1908
string title = "GE283 - Relat$$HEX1$$f300$$ENDHEX$$rio por Produto (Custo Gerencial)"
long backcolor = 80269524
pb_info pb_info
end type
global w_ge283_rentabilidade_produto_gerencial w_ge283_rentabilidade_produto_gerencial
...
If lvl_Total > 0 Then
	...
	For lvl_Row = 1 To pds_1.RowCount()
		...
		If lvdc_Vendas <> 0 Then
			...
			dw_2.Object.de_subcategoria	[lvl_Linha_Nova] = pds_1.Object.de_subcategoria	[lvl_Row]
...
For lvl_Contador = 1 To lvl_Total
	...
	Else
		If lvdc_Vendas <> 0 Then
			...
			dw_2.Object.de_grupo			[lvl_Linha_Nova] = pds_1.Object.de_grupo			[lvl_Contador]
			dw_2.Object.id_lei_generico	[lvl_Linha_Nova] = pds_1.Object.id_lei_generico	[lvl_Contador]		
			dw_2.Object.de_subgrupo		[lvl_Linha_Nova] = pds_1.Object.de_subgrupo		[lvl_Contador]		
			dw_2.Object.de_categoria		[lvl_Linha_Nova] = pds_1.Object.de_categoria		[lvl_Contador]		
			dw_2.Object.de_subcategoria	[lvl_Linha_Nova] = pds_1.Object.de_subcategoria	[lvl_Contador]		
			dw_2.Object.Qt_Vendas			[lvl_Linha_Nova] = lvl_Qtde
			dw_2.Object.Vl_Vendas			[lvl_Linha_Nova] = lvdc_Vendas
			dw_2.Object.Vl_Cmv				[lvl_Linha_Nova] = lvdc_CMV
			dw_2.Object.Vl_Comissao		[lvl_Linha_Nova] = lvdc_Comissao
...
on w_ge283_rentabilidade_produto_gerencial.create
int iCurrent
call super::create
...
on w_ge283_rentabilidade_produto_gerencial.destroy
call super::destroy
...
type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge283_rentabilidade_produto_gerencial
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge283_rentabilidade_produto_gerencial
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge283_rentabilidade_produto_gerencial
integer x = 14
integer y = 340
integer width = 3575
integer height = 1368
...
type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge283_rentabilidade_produto_gerencial
integer x = 14
integer y = 0
integer width = 1797
integer height = 332
...
type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge283_rentabilidade_produto_gerencial
integer x = 46
integer y = 60
integer width = 1751
integer height = 256
string dataobject = "dw_ge283_selecao"
end type
...
event dw_1::itemchanged;call super::itemchanged;Choose Case dwo.Name 
	...
	Case 'de_produto'
		...
		If Trim(Data) <> "" Then
			If data <> This.Object.De_Produto[1] Then
				Return 1
			End If
		Else
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge283_rentabilidade_produto_gerencial
integer x = 46
integer y = 392
integer width = 3506
integer height = 1288
string dataobject = "dw_ge283_lista"
...
If lvs_Tipo_Filiais = 'T' Then	
	If Not wf_Recupera_Informacoes(lvs_Tipo_Filiais, lvdt_Periodo, "ds_ge283_produto_geral") Then Return -1
Else
	If ivs_Filiais = "" Then
	...
	If Not wf_Recupera_Informacoes(lvs_Tipo_Filiais, lvdt_Periodo, "ds_ge283_produto_filiais") Then Return -1
End If
...
//Seta mensagem m$$HEX1$$e900$$ENDHEX$$todo do c$$HEX1$$e100$$ENDHEX$$lculo
...
event dw_2::ue_preretrieve;call super::ue_preretrieve;This.ivm_Menu.mf_SalvarComo(False)
This.ivm_Menu.mf_filtrar(False)
This.ivm_menu.mf_classificar(False)
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge283_rentabilidade_produto_gerencial
integer x = 3314
integer y = 44
integer width = 261
integer height = 164
string dataobject = "dw_ge283_relatorio"
end type
