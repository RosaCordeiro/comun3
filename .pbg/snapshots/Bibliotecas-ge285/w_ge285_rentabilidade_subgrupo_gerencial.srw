HA$PBExportHeader$w_ge285_rentabilidade_subgrupo_gerencial.srw
forward
global type w_ge285_rentabilidade_subgrupo_gerencial from dc_w_selecao_lista_relatorio
end type
type pb_info from picturebutton within w_ge285_rentabilidade_subgrupo_gerencial
end type
end forward

global type w_ge285_rentabilidade_subgrupo_gerencial from dc_w_selecao_lista_relatorio
string tag = "w_ge285_rentabilidade_subgrupo_gerencial"
integer width = 3634
integer height = 1908
string title = "GE285 - Relat$$HEX1$$f300$$ENDHEX$$rio por SubGrupo (Custo Gerencial)"
long backcolor = 80269524
pb_info pb_info
end type
global w_ge285_rentabilidade_subgrupo_gerencial w_ge285_rentabilidade_subgrupo_gerencial
...
For lvl_Contador = 1 To lvl_Total
	...
	lvs_Find = "cd_grupo = '" + lvs_Cd_Grupo + "' and cd_subgrupo = '" + lvs_Cd_SubGrupo + "'"
	
	lvl_Find = dw_2.Find(lvs_Find, 1, dw_2.RowCount())
	
	If lvl_Find < 0 Then
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro no find ao localizar o grupo: '" + lvs_Cd_Grupo + "' e o subgrupo: '" + lvs_Cd_SubGrupo + "'.", StopSign!)
		lvb_Sucesso = False
		Exit
	End If
...
on w_ge285_rentabilidade_subgrupo_gerencial.create
int iCurrent
call super::create
...
on w_ge285_rentabilidade_subgrupo_gerencial.destroy
call super::destroy
...
event ue_preopen;call super::ue_preopen;MaxWidth = 4825
MaxHeight = 9999
end event
...
type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge285_rentabilidade_subgrupo_gerencial
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge285_rentabilidade_subgrupo_gerencial
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge285_rentabilidade_subgrupo_gerencial
integer x = 14
integer y = 256
integer width = 3575
integer height = 1452
...
type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge285_rentabilidade_subgrupo_gerencial
integer x = 14
integer y = 0
integer width = 1271
integer height = 252
...
type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge285_rentabilidade_subgrupo_gerencial
integer x = 46
integer y = 56
integer width = 1221
integer height = 184
string dataobject = "dw_ge285_selecao"
end type
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge285_rentabilidade_subgrupo_gerencial
integer x = 46
integer y = 308
integer width = 3506
integer height = 1372
string dataobject = "dw_ge285_lista"
...
If lvs_Tipo_Filiais = 'T' Then	
	If Not wf_Recupera_Informacoes(lvs_Tipo_Filiais, lvdt_Periodo, "ds_ge285_subgrupo_geral") Then Return -1
Else
	If ivs_Filiais = "" Then
	...
	If Not wf_Recupera_Informacoes(lvs_Tipo_Filiais, lvdt_Periodo, "ds_ge285_subgrupo_filiais") Then Return -1
End If
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge285_rentabilidade_subgrupo_gerencial
integer x = 1371
integer y = 48
integer height = 164
string dataobject = "dw_ge285_relatorio"
end type
