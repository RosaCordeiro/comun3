HA$PBExportHeader$w_ge288_rentabilidade_medic_otc_gerencia.srw
forward
global type w_ge288_rentabilidade_medic_otc_gerencia from dc_w_selecao_lista_relatorio
end type
type pb_info from picturebutton within w_ge288_rentabilidade_medic_otc_gerencia
end type
end forward

global type w_ge288_rentabilidade_medic_otc_gerencia from dc_w_selecao_lista_relatorio
string tag = "w_ge288_rentabilidade_medic_otc_gerencia"
integer width = 3634
integer height = 1908
string title = "GE288 - Relat$$HEX1$$f300$$ENDHEX$$rio por Medicamentos (Custo Gerencial)"
long backcolor = 80269524
pb_info pb_info
end type
global w_ge288_rentabilidade_medic_otc_gerencia w_ge288_rentabilidade_medic_otc_gerencia
...
For lvl_Row = 1 To lvl_Total
	...
	If lvdc_Vendas <> 0 Then
		...
		dw_2.Object.Id_Situacao_Pis	[lvl_Linha_Nova] = pds_1.Object.Id_Situacao_Pis_Cofins[lvl_Row]
		dw_2.Object.Id_Lei_Generico	[lvl_Linha_Nova] = pds_1.Object.Id_Lei_Generico       [lvl_Row]		
...
For lvl_Contador = 1 To pds_1.RowCount()
	lvs_Id_Situacao_Pis	= pds_1.Object.Id_Situacao_Pis_Cofins[lvl_Contador]
	lvs_Id_Lei_Generico	= pds_1.Object.Id_Lei_Generico	[lvl_Contador]
	...
	lvs_Find = "id_situacao_pis = '" + lvs_Id_Situacao_Pis + "' and " +&
				  "id_lei_generico = '" + lvs_Id_Lei_Generico + "'"
				  
	lvl_Find = dw_2.Find(lvs_Find, 1, dw_2.RowCount())
	
	If lvl_Find < 0 Then
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro no find ao localizar a situa$$HEX2$$e700e300$$ENDHEX$$o PIS/COFINS: " + lvs_Id_Situacao_Pis + " e lei: " + lvs_Id_Lei_Generico, StopSign!)
		lvb_Sucesso = False
		Exit
	End If
	...
	Else
		If lvdc_Vendas <> 0 Then
			...
			dw_2.Object.Id_Situacao_Pis[lvl_Linha_Nova] = lvs_Id_Situacao_Pis
			dw_2.Object.Id_Lei_Generico[lvl_Linha_Nova] = lvs_Id_Lei_Generico
			dw_2.Object.Qt_Vendas		[lvl_Linha_Nova] = lvl_Qtde
			dw_2.Object.Vl_Vendas		[lvl_Linha_Nova] = lvdc_Vendas
			dw_2.Object.Vl_Cmv			[lvl_Linha_Nova] = lvdc_CMV
			dw_2.Object.Vl_Comissao	[lvl_Linha_Nova] = lvdc_Comissao
...
on w_ge288_rentabilidade_medic_otc_gerencia.create
int iCurrent
call super::create
...
on w_ge288_rentabilidade_medic_otc_gerencia.destroy
call super::destroy
...
event ue_preopen;call super::ue_preopen;MaxWidth = 4525
MaxHeight = 9999
end event
...
type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge288_rentabilidade_medic_otc_gerencia
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge288_rentabilidade_medic_otc_gerencia
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge288_rentabilidade_medic_otc_gerencia
integer x = 14
integer y = 320
integer width = 3575
integer height = 1388
...
type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge288_rentabilidade_medic_otc_gerencia
integer x = 14
integer y = 0
integer width = 1271
integer height = 316
...
type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge288_rentabilidade_medic_otc_gerencia
integer x = 46
integer y = 48
integer width = 1225
integer height = 260
string dataobject = "dw_ge288_selecao"
end type
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge288_rentabilidade_medic_otc_gerencia
integer x = 46
integer y = 372
integer width = 3506
integer height = 1308
string dataobject = "dw_ge288_lista_pis"
...
If lvs_Tipo_Filiais = 'T' Then	
	If Not wf_Recupera_Informacoes(lvs_Tipo_Filiais, lvdt_Periodo, "ds_ge288_pis_geral") Then Return -1
Else
	If ivs_Filiais = "" Then
	...
	If Not wf_Recupera_Informacoes(lvs_Tipo_Filiais, lvdt_Periodo, "ds_ge288_pis_filiais") Then Return -1
End If
...
event dw_2::ue_preretrieve;call super::ue_preretrieve;String lvs_Apresentacao, &
       lvs_Dw, &
		 lvs_Dw_Rel

dw_1.AcceptText()

lvs_Apresentacao = dw_1.Object.Apresentacao[1]

lvs_Dw     = "dw_ge288_lista_"
lvs_Dw_Rel = "dw_ge288_relatorio_"

If lvs_Apresentacao = 'P' Then
	lvs_Dw     = lvs_Dw + "pis"
	lvs_Dw_Rel = lvs_Dw_Rel + "pis"
Else
	lvs_Dw     = lvs_Dw + "lei"
	lvs_Dw_Rel = lvs_Dw_Rel + "lei"
End If

If Not This.of_ChangeDataObject(lvs_Dw) Then Return -1
If Not dw_3.of_ChangeDataObject(lvs_Dw_Rel) Then Return -1
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge288_rentabilidade_medic_otc_gerencia
integer x = 1335
integer y = 24
integer width = 457
integer height = 252
string dataobject = "dw_ge288_relatorio_pis"
end type
