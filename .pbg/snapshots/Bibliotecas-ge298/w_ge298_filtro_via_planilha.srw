HA$PBExportHeader$w_ge298_filtro_via_planilha.srw
forward
global type w_ge298_filtro_via_planilha from dc_w_response_ok_cancela
end type
type cb_1 from commandbutton within w_ge298_filtro_via_planilha
end type
end forward
...
integer width = 2162
integer height = 432
string title = "GE298 - Filtra Produto via Planilha"
cb_1 cb_1
end type
global w_ge298_filtro_via_planilha w_ge298_filtro_via_planilha
...
on w_ge298_filtro_via_planilha.create
int iCurrent
call super::create
...
on w_ge298_filtro_via_planilha.destroy
call super::destroy
destroy(this.cb_1)
end on

type pb_help from dc_w_response_ok_cancela`pb_help within w_ge298_filtro_via_planilha
end type

type gb_1 from dc_w_response_ok_cancela`gb_1 within w_ge298_filtro_via_planilha
integer y = 8
integer width = 2075
integer height = 188
end type

type dw_1 from dc_w_response_ok_cancela`dw_1 within w_ge298_filtro_via_planilha
integer y = 72
integer width = 2016
integer height = 96
...
type cb_ok from dc_w_response_ok_cancela`cb_ok within w_ge298_filtro_via_planilha
integer x = 1463
integer y = 224
end type
...
type cb_cancelar from dc_w_response_ok_cancela`cb_cancelar within w_ge298_filtro_via_planilha
integer x = 1797
integer y = 224
end type
