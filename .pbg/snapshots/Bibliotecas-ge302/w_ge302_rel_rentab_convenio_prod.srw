HA$PBExportHeader$w_ge302_rel_rentab_convenio_prod.srw
forward
global type w_ge302_rel_rentab_convenio_prod from dc_w_selecao_lista_relatorio
end type
type pb_info from picturebutton within w_ge302_rel_rentab_convenio_prod
end type
end forward

global type w_ge302_rel_rentab_convenio_prod from dc_w_selecao_lista_relatorio
string tag = "w_ge302_rel_rentab_convenio_prod"
integer width = 4480
integer height = 1888
string title = "GE302 - Relat$$HEX1$$f300$$ENDHEX$$rio de Rentabilidade Conv$$HEX1$$ea00$$ENDHEX$$nio por Produto"
long backcolor = 80269524
pb_info pb_info
end type
global w_ge302_rel_rentab_convenio_prod w_ge302_rel_rentab_convenio_prod
...
Try
	...
	If Not lvds_1.Of_ChangeDataObject("ds_ge302_venda") Then Return
	If Not lvds_2.Of_ChangeDataObject("ds_ge302_devolucao") Then Return
	...
	For lvl_Linha = 1 To lvl_Linhas
		...
		lvl_Find = lvds_1.Find("cd_produto="+String(lvl_Produto)+" and id_situacao_pis_cofins='"+lvs_Lista_Pis+"'",1,lvds_1.RowCount())
	...
	For lvl_Linha = 1 To lvl_Linhas
		...
		lvs_Produto  			= lvds_1.Object.de_produto					[lvl_Linha]
...
on w_ge302_rel_rentab_convenio_prod.create
int iCurrent
call super::create
...
on w_ge302_rel_rentab_convenio_prod.destroy
call super::destroy
...
type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge302_rel_rentab_convenio_prod
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge302_rel_rentab_convenio_prod
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge302_rel_rentab_convenio_prod
integer x = 18
integer y = 364
integer width = 4393
integer height = 1320
...
type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge302_rel_rentab_convenio_prod
integer x = 18
integer y = 8
integer width = 4192
integer height = 336
...
type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge302_rel_rentab_convenio_prod
integer x = 46
integer y = 72
integer width = 4151
integer height = 248
string dataobject = "dw_ge302_selecao"
end type
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge302_rel_rentab_convenio_prod
integer x = 50
integer y = 440
integer width = 4311
integer height = 1188
string dataobject = "dw_ge302_lista"
...
If IsNull(lvl_Convenio) or (Not (lvl_Convenio > 0)) Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o!", "Informe um conv$$HEX1$$ea00$$ENDHEX$$nio para recuperar as informa$$HEX2$$e700f500$$ENDHEX$$es.")
	dw_1.SetFocus()
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge302_rel_rentab_convenio_prod
integer x = 1376
integer y = 36
integer width = 375
integer height = 116
string dataobject = "dw_ge302_relatorio"
end type
...
dw_3.Object.st_convenio.text 	= lvs_Convenio
