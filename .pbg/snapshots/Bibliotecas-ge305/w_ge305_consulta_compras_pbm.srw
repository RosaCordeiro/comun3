HA$PBExportHeader$w_ge305_consulta_compras_pbm.srw
forward
global type w_ge305_consulta_compras_pbm from dc_w_selecao_lista_relatorio
end type
end forward
...
integer width = 3273
integer height = 1868
string title = "GE305 - Consulta Compras Reposi$$HEX2$$e700e300$$ENDHEX$$o PBM"
end type
global w_ge305_consulta_compras_pbm w_ge305_consulta_compras_pbm
...
on w_ge305_consulta_compras_pbm.create
call super::create
end on

on w_ge305_consulta_compras_pbm.destroy
call super::destroy
...
type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge305_consulta_compras_pbm
integer y = 360
integer width = 3173
integer height = 1304
integer weight = 700
...
type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge305_consulta_compras_pbm
integer width = 3163
integer height = 336
integer weight = 700
end type

type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge305_consulta_compras_pbm
integer width = 3095
string dataobject = "dw_ge305_selecao"
end type
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge305_consulta_compras_pbm
integer y = 436
integer width = 3104
integer height = 1196
string dataobject = "dw_ge305_lista"
...
If (Not IsNull(lvl_Nota))and(lvl_Nota > 0) Then
	This.Of_appendwhere('n.nr_nf = '+String(lvl_Nota))
End If
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge305_consulta_compras_pbm
integer x = 3232
integer y = 100
integer width = 251
end type
