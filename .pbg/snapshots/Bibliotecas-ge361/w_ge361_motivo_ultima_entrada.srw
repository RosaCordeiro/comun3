HA$PBExportHeader$w_ge361_motivo_ultima_entrada.srw
forward
global type w_ge361_motivo_ultima_entrada from dc_w_selecao_lista_relatorio
end type
end forward
...
global w_ge361_motivo_ultima_entrada w_ge361_motivo_ultima_entrada
...
public function boolean wf_dados_movimentacao_nova (long al_filial, long al_produto, ref date adt_ultima_entrada, ref string as_tipo, ref string as_motivo_entrada)
end prototypes
...
//		If Not wf_Dados_Promocao(ll_Filial, ll_Produto, Ref ls_Possui_Promo_Plan, Ref ll_Qt_Est_Min) Then Return False
		...
		If Not wf_Dados_Movimentacao_Nova(ll_Filial, ll_Produto, Ref ldt_Ultima_Entrada, Ref ls_Tipo, Ref ls_Motivo) Then Return False
...
public function boolean wf_dados_movimentacao_nova (long al_filial, long al_produto, ref date adt_ultima_entrada, ref string as_tipo, ref string as_motivo_entrada);Long ll_Ped_Dist
Long ll_Nr_Nf
Long ll_Filial
Long ll_Pedido_Dist
Long ll_Pedido_Fil
...
on w_ge361_motivo_ultima_entrada.create
call super::create
end on

on w_ge361_motivo_ultima_entrada.destroy
call super::destroy
...
event ue_postopen;call super::ue_postopen;dw_1.Object.Dh_Movimento[1] = DateTime(RelativeDate(Date(gvo_Parametro.of_Dh_Movimentacao()), -3))
end event
...
type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge361_motivo_ultima_entrada
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge361_motivo_ultima_entrada
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge361_motivo_ultima_entrada
integer y = 288
integer width = 4325
integer height = 1712
end type

type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge361_motivo_ultima_entrada
integer width = 3387
integer height = 268
end type

type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge361_motivo_ultima_entrada
integer width = 3323
integer height = 168
string dataobject = "dw_ge361_selecao"
end type
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge361_motivo_ultima_entrada
integer y = 364
integer width = 4247
integer height = 1600
string dataobject = "dw_ge361_lista"
...
If ls_Conjunto = "C" And il_Lojas > 0 Then
	This.of_AppendWhere_SubQuery("s.cd_filial in (" + ivs_Filiais + ")", 5)
End If

If ls_Planograma = "C" Then	
	This.of_AppendWhere_SubQuery("g.cd_planograma in (" + io_planogramas.is_Planogramas + ")", 5)
End If

If Not IsNull(ll_Produto) And ll_Produto > 0 Then
	This.of_AppendWhere_SubQuery("s.cd_produto = " + String(ll_Produto), 5)
End If
...
Return This.Retrieve(ldt_Atual, dw_1.Object.Dh_Movimento[1])
end event
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge361_motivo_ultima_entrada
integer x = 2670
integer y = 1072
string dataobject = "dw_ge361_lista_movimento"
end type
...
Return This.Retrieve(dw_1.Object.Dh_Movimento[1])
end event
