HA$PBExportHeader$w_ge380_copia_promocao.srw
forward
global type w_ge380_copia_promocao from dc_w_response
end type
type gb_1 from groupbox within w_ge380_copia_promocao
end type
type dw_1 from dc_uo_dw_base within w_ge380_copia_promocao
end type
type cb_confirmar from commandbutton within w_ge380_copia_promocao
end type
type cb_cancelar from commandbutton within w_ge380_copia_promocao
end type
end forward
...
global w_ge380_copia_promocao w_ge380_copia_promocao
...
on w_ge380_copia_promocao.create
int iCurrent
call super::create
...
on w_ge380_copia_promocao.destroy
call super::destroy
destroy(this.gb_1)
destroy(this.dw_1)
...
type pb_help from dc_w_response`pb_help within w_ge380_copia_promocao
end type
...
string dataobject = "dw_ge380_promocao_copia"
end type
...
st.Id_Copia = "S"
st.Cd_Promocao	= lvl_Promocao
st.Id_Produto		= lvs_Produto
st.Id_Filial			= lvs_Filial
