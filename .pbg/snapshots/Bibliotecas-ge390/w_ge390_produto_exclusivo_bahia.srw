HA$PBExportHeader$w_ge390_produto_exclusivo_bahia.srw
forward
global type w_ge390_produto_exclusivo_bahia from dc_w_cadastro_selecao_lista
end type
type cb_planilha from commandbutton within w_ge390_produto_exclusivo_bahia
end type
type dw_3 from dc_uo_dw_base within w_ge390_produto_exclusivo_bahia
end type
type cb_1 from commandbutton within w_ge390_produto_exclusivo_bahia
end type
end forward
...
integer width = 4663
integer height = 1900
string title = "GE390 - Cadastro de Produtos Exclusivos para a Bahia"
cb_planilha cb_planilha
dw_3 dw_3
cb_1 cb_1
end type
global w_ge390_produto_exclusivo_bahia w_ge390_produto_exclusivo_bahia
...
Try
	...
	For ll_Linha = 1 To dw_3.RowCount()
		...
		If ll_Find = 0 Then
			...
			Update produto_central
				Set id_exclusivo_pedido_falta_ba = 'N'
			...
			If SqlCa.SqlCode = -1 Then
				...
				SqlCa.of_Rollback();
				MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro ao atualizar o 'id_exclusivo_pedido_falta_ba' da tabela produto_central. " + ls_Erro, StopSign!)
				Return False
			End If
			
			If Not gf_grava_historico_alteracao_tabela('PRODUTO_CENTRAL', String(ll_Produto), 'ID_EXCLUSIVO_PEDIDO_FALTA_BA', 'S', 'N', gvo_Aplicacao.ivo_Seguranca.Nr_Matricula, 'E', Ref ls_Erro, True) Then Return False
		End If
	Next
	...
	For ll_Linha = 1 To dw_2.RowCount()
		...
		If ll_Find = 0 Then		
			If Not lo_Regras.of_Grava_Produto(ll_Produto,'', False) Then Return False
		End If
	Next
...
//Se j$$HEX1$$e100$$ENDHEX$$ teve pedido gerado na data atual n$$HEX1$$e300$$ENDHEX$$o $$HEX1$$e900$$ENDHEX$$ permitida a exclus$$HEX1$$e300$$ENDHEX$$o
If ll_Achou > 0 Then
	ab_Permite = False
End If
...
on w_ge390_produto_exclusivo_bahia.create
int iCurrent
call super::create
...
on w_ge390_produto_exclusivo_bahia.destroy
call super::destroy
...
Select id_inclusao, 
	...
	Where cd_sistema			= :gvo_Aplicacao.ivo_Seguranca.cd_sistema
	  and cd_procedimento	= 'W_GE390_PRODUTO_EXCLUSIVO_BAHIA'
...
type dw_visual from dc_w_cadastro_selecao_lista`dw_visual within w_ge390_produto_exclusivo_bahia
integer x = 37
integer y = 740
end type

type gb_aux_visual from dc_w_cadastro_selecao_lista`gb_aux_visual within w_ge390_produto_exclusivo_bahia
integer x = 0
integer y = 668
end type

type dw_1 from dc_w_cadastro_selecao_lista`dw_1 within w_ge390_produto_exclusivo_bahia
integer width = 1952
integer height = 164
...
type gb_2 from dc_w_cadastro_selecao_lista`gb_2 within w_ge390_produto_exclusivo_bahia
integer y = 292
integer width = 4539
integer height = 1380
end type

type gb_1 from dc_w_cadastro_selecao_lista`gb_1 within w_ge390_produto_exclusivo_bahia
integer width = 2021
integer height = 272
end type

type dw_2 from dc_w_cadastro_selecao_lista`dw_2 within w_ge390_produto_exclusivo_bahia
integer y = 368
integer width = 4466
integer height = 1276
		...
		Case "de_produto"
			...
			If io_Produto.Localizado Then
				...
				Try
					...
					If Not lo_Regras.of_Verifica_Produto_Ja_Incluido(io_Produto.Cd_Produto,'') Then
						MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Produto " + String(io_Produto.Cd_Produto) + " j$$HEX1$$e100$$ENDHEX$$ $$HEX1$$e900$$ENDHEX$$ exclusivo.", Exclamation!)
						Return 1
					End If
...
If Not IsNull(ll_Produto) And ll_Produto > 0 Then
	This.of_AppendWhere_SubQuery("c.cd_produto = " + String(ll_Produto), 2)
End If
