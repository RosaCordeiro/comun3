HA$PBExportHeader$w_ge464_cadastro_promo_automatica.srw
forward
global type w_ge464_cadastro_promo_automatica from dc_w_response_ok_cancela
end type
type cb_1 from commandbutton within w_ge464_cadastro_promo_automatica
end type
type dw_2 from dc_uo_dw_base within w_ge464_cadastro_promo_automatica
end type
end forward
...
integer width = 2158
integer height = 468
string title = "GE464 - Cadastrar Promo$$HEX2$$e700f500$$ENDHEX$$es Progressiva"
cb_1 cb_1
dw_2 dw_2
end type
global w_ge464_cadastro_promo_automatica w_ge464_cadastro_promo_automatica
...
Decimal ll_Cd_Progre
Decimal ll_Cd_Progre_Clube
	...
	If ( lo_Excel.uo_Referencia_Objeto_Excel(ls_Arquivo) ) Then
		...
		If ll_Linhas > 0 Then
			...
			For ll_Linha = 1 To ll_Linhas
				...
				//DescPromocao Progressiva
				la_Dado = lo_Excel.uo_Lendo_Dados(ll_Linha, "B")
							
				ll_Cd_Progre =  Long(la_Dado)				
				
				//DescClube Progressivo
				la_Dado = lo_Excel.uo_Lendo_Dados(ll_Linha, "C")								
				
				ll_Cd_Progre_Clube =   Long(la_Dado)												
				
				If  (IsNull(ll_Cd_Progre)  and IsNull(ll_Cd_Progre_Clube))   Then 
					MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Deve ser informado o Desconto Progressivo ou Desconto Clube. ~rColuna 'B ou C' na linha '" + String(ll_Linha) + "'.", StopSign!)
					Return False
				End If 							
				...
				If dw_1.Object.Id_Tipo_Promocao[1] = "Q" Then
					If IsNull(la_Dado) Or Not IsNumber(String(la_Dado)) Then
						MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Sequencial auxiliar inv$$HEX1$$e100$$ENDHEX$$lido. ~rColuna 'M' na linha '" + String(ll_Linha) + "'.", StopSign!)
						Return False
					End If
				End If
				...
				dw_2.Object.descclube[ll_Linha_Dw] = ll_Cd_Progre
				dw_2.Object.descpromocao[ll_Linha_Dw] = ll_Cd_Progre_Clube
...
on w_ge464_cadastro_promo_automatica.create
int iCurrent
call super::create
...
on w_ge464_cadastro_promo_automatica.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.dw_2)
end on
...
type pb_help from dc_w_response_ok_cancela`pb_help within w_ge464_cadastro_promo_automatica
end type

type gb_1 from dc_w_response_ok_cancela`gb_1 within w_ge464_cadastro_promo_automatica
integer width = 2080
integer height = 268
integer weight = 700
...
type dw_1 from dc_w_response_ok_cancela`dw_1 within w_ge464_cadastro_promo_automatica
integer width = 2021
integer height = 184
string dataobject = "dw_ge464_selecao_promo_auto"
end type
...
type cb_ok from dc_w_response_ok_cancela`cb_ok within w_ge464_cadastro_promo_automatica
integer x = 1088
integer y = 280
integer width = 677
...
Long 	ll_CodigoProgressivoClube,&
		ll_CodigoProgressivo
...
Choose Case lvs_Tipo_Promocao
	Case "Q" //Promo$$HEX2$$e700e300$$ENDHEX$$o Progressiva
		ls_Descricao = "Promo$$HEX2$$e700e300$$ENDHEX$$o Progressiva"	
...
If MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Aquivo Excel, foi Conferido ? Confirma a inclus$$HEX1$$e300$$ENDHEX$$o das promo$$HEX2$$e700f500$$ENDHEX$$es do tipo '" + ls_Descricao +"' ?", Question!, YesNo!, 2) = 2 Then Return -1
ll_PcDesconto = 0 
ll_PcDescontoClube = 0
...
Try
	...
	If Not ids_Rede.of_ChangeDataObject("dw_ge464_rede") Then
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro ao carregar a ds 'dw_ge464_rede'.", StopSign!)
		Return -1
	End If
	...
	If ids_Rede.Retrieve() < 0 Then
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro no retrieve da ds 'dw_ge464_rede'.", StopSign!)
		Return -1
	End If
	...
	For ll_Linha = 1 to dw_2.RowCount()
		...
		ll_CodigoProgressivo 			= dw_2.Object.descclube			[ll_Linha]
		ll_CodigoProgressivoClube 	= dw_2.Object.descpromocao		[ll_Linha]
		...
		insert into promocao_sos_produto(cd_promocao_sos, cd_produto, pc_desconto, id_carregado_as400, dh_alteracao, nr_matricula_alteracao, pc_desconto_clube, cd_desc_progressivo ,  cd_desc_progressivo_clube )
		values (:ll_MaxPromo,  :ll_Produto,:ll_PcDesconto, 'N', :ldh_data, :gvo_Aplicacao.ivo_Seguranca.Nr_Matricula, :ll_PcDescontoClube, :ll_CodigoProgressivo , :ll_CodigoProgressivoClube   )
		Using SqlCA;
...
type cb_cancelar from dc_w_response_ok_cancela`cb_cancelar within w_ge464_cadastro_promo_automatica
integer x = 1797
integer y = 280
end type
...
MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Os dados devem estar da seguinte forma:~r" + &
								...
								"~rColuna B = C$$HEX1$$f300$$ENDHEX$$digo do Desconto Progressivo" + &
								"~rColuna C = C$$HEX1$$f300$$ENDHEX$$digo do Desconto Progressivo Clube" + &
								...
								"~rColuna M = Sequencial Auxiliar (controla se haver$$HEX1$$e100$$ENDHEX$$ mais de um produto na promo$$HEX2$$e700e300$$ENDHEX$$o)")								
