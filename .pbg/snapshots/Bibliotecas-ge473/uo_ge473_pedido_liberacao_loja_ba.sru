	...
	If ll_Linhas > 0 Then
		For ll_Linha = 1 To ll_Linhas
			...
			Try
				...
				lo_pedido_liberacao_loja_ba.of_atualiza_pedido_liberacao_loja_ba(lds.Object.nr_controle[ll_Linha] ,  il_Tabela )
			Finally
...
Try
	...
	If lo_Comum.of_processa_carrega_dados(al_controle, ref ls_Log) Then
		...
		If ll_Linhas = 1 Then
			...
			if isvalid(w_aguarde_3) Then
				w_aguarde_3.wf_settext('Filial: ' + String(il_filial), 3 )
			end if
