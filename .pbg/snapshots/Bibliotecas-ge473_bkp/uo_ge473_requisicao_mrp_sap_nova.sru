...
public function boolean of_atualiza_requisicao_mrp_sap (long al_controle, long al_tabela)
...
public function boolean of_atualiza_requisicao_mrp_sap (long al_controle, long al_tabela);Boolean lb_Sucesso = False
...
Try
	...
	If lo_Comum.of_processa_carrega_dados(al_controle, al_tabela, ref ls_Log) Then
		...
		If ll_Linhas = 1 Then
			...
			is_id_tipo  		 	= lo_Comum.ids_lista_registros.Object.id_tipo_requisicao	[1]				
			
			If Not io_Comum.of_date_time(lo_Comum.ids_lista_registros.Object.dh_envio[1], 'DH_ENVIO', ref  idt_dh_envio, ref ls_Log) Then Return False				
...
Try
	...
	If lo_Comum.of_processa_carrega_dados(ll_Controle_filho, 30, ref as_Log) Then		
		For ll_Linha = 1 To lo_Comum.ids_lista_registros.RowCount()
			...
			If ll_NR_Requisicao <> il_nr_requisicao Then
				as_Log = 'N$$HEX1$$fa00$$ENDHEX$$mero da requis$$HEX1$$e300$$ENDHEX$$o do item [' + String(ll_NR_Requisicao) + '] est$$HEX1$$e100$$ENDHEX$$ diferente do cabe$$HEX1$$e700$$ENDHEX$$alho ['  + String(il_nr_requisicao) + '].'
				Return False
			End If
			// Requisi$$HEX2$$e700e300$$ENDHEX$$o			
			...
			// Filial
			If Not io_Comum.of_Localiza_Codigo_Filial_Legado( lo_Comum.ids_lista_registros.Object.cd_filial_legado[ll_Linha] , Ref ll_Filial, Ref as_Log) Then Return False
			...
			If Not io_Comum.of_Localiza_Codigo_Produto_Legado(lo_Comum.ids_lista_registros.Object.cd_produto_sap[ll_Linha], Ref ll_Produto, Ref as_Log) Then Return False
			// Produto
			...
			// Data da remessa
			If Not io_Comum.of_date_time(lo_Comum.ids_lista_registros.Object.dh_remessa[ll_Linha], 'DH_REMESSA', ref ldh_Remessa, ref as_Log) Then Return False
