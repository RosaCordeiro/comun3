...
public function boolean wf_processa ();String ls_Log
		...
		If tab_1.TabPage_1.dw_2.Object.id_processa[ll_Linha] = 'S' and (tab_1.TabPage_1.dw_2.Object.id_situacao[ll_Linha]  = 'C' or tab_1.TabPage_1.dw_2.Object.id_situacao[ll_Linha]  = 'E') Then
			...
			Choose Case ll_Tabela
				...
				Case 29	//Requisi$$HEX2$$e700e300$$ENDHEX$$o MRP SAP 
					     //--- Processamento do Header da Requisi$$HEX2$$e700e300$$ENDHEX$$o --//
						Try
							    //---- Processa Header da Requisi$$HEX2$$e700e300$$ENDHEX$$o --//
							    uo_ge473_requisicao_mrp_sap lo_requisicao_mrp_sap
                                    lo_requisicao_mrp_sap = create  uo_ge473_requisicao_mrp_sap
								//				
                                    IF lo_requisicao_mrp_sap.of_atualiza_requisicao_mrp_sap( ll_Controle ) Then
						                    //---  Processa Itens da Requisa$$HEX2$$e700e300$$ENDHEX$$o ---//
										  uo_ge473_requisicao_mrp_sap_item  lo_requisicao_mrp_sap_item
										  lo_requisicao_mrp_sap_item = create  uo_ge473_requisicao_mrp_sap_item
											//		
										  If  lo_requisicao_mrp_sap_item.of_atualiza_requisicao_mrp_sap_item( ll_Controle ) Then 
											         Messagebox ( "Interface Requisi$$HEX2$$e700e300$$ENDHEX$$o MRP SAP", "Controle: " + Trim(String( ll_Controle)) + " Termino OK")
										      Else
								                            Messagebox ( "Interface Requisi$$HEX2$$e700e300$$ENDHEX$$o MRP SAP", " Controle: " + string(  ll_Controle ) + " ~n " + &
											                                   "Termino com erro!",  StopSign!)
										   End IF	
					        ...
					        Finally
							   If isvalid ( lo_requisicao_mrp_sap )         then  Destroy ( lo_requisicao_mrp_sap )
						        If isvalid ( lo_requisicao_mrp_sap_item ) then  Destroy ( lo_requisicao_mrp_sap_item )
					     End Try						  
						  
				Case 30	//Requisi$$HEX2$$e700e300$$ENDHEX$$o MRP SAP Item		
					     //-- este arquivo requisi$$HEX2$$e700e300$$ENDHEX$$o MRP SAP Item $$HEX1$$e900$$ENDHEX$$ processado junto com o $$HEX1$$ed00$$ENDHEX$$tem --//
						MessageBox('Aten$$HEX2$$e700e300$$ENDHEX$$o', 'Processe apenas os Header das Requisi$$HEX2$$e700f500$$ENDHEX$$es.', StopSign!)  
				...
				Case 36	// Preparar o sistema da CLAMED para receber de libera$$HEX2$$e700e300$$ENDHEX$$o de pedido para loja nova.
					...
					Case 37
						...
						Try
							...
							lo_pedido_liberacao_loja_ba.of_atualiza_pedido_liberacao_loja_ba( ll_Controle,  ll_Tabela)
						 Finally
...
If  gvo_Aplicacao.ivo_Seguranca.Cd_Sistema = "GC" Then
	...
	If Tab_1.TabPage_1.dw_1.GetChild("cd_tabela", lvdwc) = 1 Then
		...
		ls_SQL	=	"SELECT	tabela_interface_sap.cd_tabela,  " +& 
						...
						"and cd_sistema in ('GC')"
		
		lvdwc.SetSQLSelect(ls_SQL)
			
		lvdwc.Retrieve()
		
		Tab_1.TabPage_1.dw_1.Object.cd_tabela[1] = 1 //Produto
...
lo_Produto_SAP.of_envia_sap_codigo_legado('1000000491', '424XXX', ref ls_Log )
