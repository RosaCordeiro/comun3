...
Try
	...
	If lo_Comum.of_processa_carrega_dados(al_controle, ref ls_Log) Then
		...
		If ll_Linhas = 1 Then
			...
			is_Liberado					= lo_Comum.ids_lista_registros.Object.id_liberado			[1]
		   ...
		   If Not lo_Comum.of_Localiza_Codigo_Filial_Legado(is_Filial_Sap, Ref il_Filial, Ref ls_Log) Then Return False
			...
			If This.of_atualiza_fornecedor_conexao(il_Filial , is_Fornecedor, is_Liberado,  ref ls_Log ) Then
				lb_Sucesso = True
			End If
