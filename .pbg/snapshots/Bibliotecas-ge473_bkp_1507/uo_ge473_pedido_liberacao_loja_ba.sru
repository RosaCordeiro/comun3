...
public function boolean of_atualiza_pedido_liberacao_loja_ba (long al_controle)
end prototypes
...
public function boolean of_atualiza_pedido_liberacao_loja_ba (long al_controle);Boolean lb_Sucesso = False
