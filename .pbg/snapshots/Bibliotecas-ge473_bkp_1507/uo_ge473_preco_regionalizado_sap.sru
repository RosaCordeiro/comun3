...
forward prototypes
public function boolean of_atualiza_preco_regionalizado (long al_controle)
...
public function boolean of_atualiza_preco_regionalizado (long al_controle);dc_uo_ds_base lds
