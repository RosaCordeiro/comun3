HA$PBExportHeader$uo_ge481_est_nf_diversa.sru
forward
global type uo_ge481_est_nf_diversa from uo_ge481_subida_generica
end type
end forward

global type uo_ge481_est_nf_diversa from uo_ge481_subida_generica autoinstantiate
end type
...
is_DS = 'ds_ge481_est_nf_diversa'
is_Objeto = this.classname( )
is_nome_arquivo = 'est_nf_diversa'
is_Parametro_URL = 'CD_URL_EST_NF_DIVERSA'
is_Tipo_Log_Exp = 'EST_NF_DIVERSA'
is_Descricao_Tipo_Log = 'EST_NF_DIVERSA'
is_Nome_Interface = 'EST_NF_DIVERSA'
...
on uo_ge481_est_nf_diversa.create
call super::create
end on

on uo_ge481_est_nf_diversa.destroy
call super::destroy
end on
