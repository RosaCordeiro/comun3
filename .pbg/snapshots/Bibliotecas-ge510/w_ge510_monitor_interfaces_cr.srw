HA$PBExportHeader$w_ge510_monitor_interfaces_cr.srw
forward
global type w_ge510_monitor_interfaces_cr from dc_w_selecao_lista_relatorio
end type
type st_1 from statictext within w_ge510_monitor_interfaces_cr
end type
type st_data from statictext within w_ge510_monitor_interfaces_cr
end type
type st_2 from statictext within w_ge510_monitor_interfaces_cr
end type
type iuo_1 from uo_ge510_monitor_ifood within w_ge510_monitor_interfaces_cr
end type
type iuo_2 from uo_ge510_monitor_ifood within w_ge510_monitor_interfaces_cr
end type
type iuo_3 from uo_ge510_monitor_ifood within w_ge510_monitor_interfaces_cr
end type
type iuo_4 from uo_ge510_monitor_ifood within w_ge510_monitor_interfaces_cr
end type
end forward
...
integer width = 5618
integer height = 1984
string title = "GE510 - Monitor Interfaces Consulta Rem$$HEX1$$e900$$ENDHEX$$dios"
st_1 st_1
st_data st_data
st_2 st_2
iuo_1 iuo_1
...
global w_ge510_monitor_interfaces_cr w_ge510_monitor_interfaces_cr
...
iuo_1.of_carrega_interface( is_id_ecommerce, 8, ref ls_log )
iuo_2.of_carrega_interface( is_id_ecommerce, 9, ref ls_log )
iuo_3.of_carrega_interface( is_id_ecommerce, 13, ref ls_log )
iuo_4.of_carrega_interface( is_id_ecommerce, 2, ref ls_log )
...
on w_ge510_monitor_interfaces_cr.create
int iCurrent
call super::create
...
on w_ge510_monitor_interfaces_cr.destroy
call super::destroy
...
type dw_visual from dc_w_selecao_lista_relatorio`dw_visual within w_ge510_monitor_interfaces_cr
integer x = 873
integer y = 1868
end type

type gb_aux_visual from dc_w_selecao_lista_relatorio`gb_aux_visual within w_ge510_monitor_interfaces_cr
integer x = 841
integer y = 1812
end type

type gb_2 from dc_w_selecao_lista_relatorio`gb_2 within w_ge510_monitor_interfaces_cr
integer y = 280
integer width = 5504
integer height = 1512
...
type gb_1 from dc_w_selecao_lista_relatorio`gb_1 within w_ge510_monitor_interfaces_cr
integer width = 5504
integer height = 252
end type

type dw_1 from dc_w_selecao_lista_relatorio`dw_1 within w_ge510_monitor_interfaces_cr
integer y = 68
integer width = 1861
integer height = 176
...
type dw_2 from dc_w_selecao_lista_relatorio`dw_2 within w_ge510_monitor_interfaces_cr
...
type dw_3 from dc_w_selecao_lista_relatorio`dw_3 within w_ge510_monitor_interfaces_cr
boolean visible = false
integer x = 2208
integer y = 76
integer width = 485
