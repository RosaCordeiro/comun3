HA$PBExportHeader$w_ge534_motivo_pedido_empurrado.srw
forward
global type w_ge534_motivo_pedido_empurrado from dc_w_cadastro_lista
end type
end forward
...
integer width = 1934
integer height = 1500
string title = "w_gc026_motivo_pedido_empurrado"
end type
global w_ge534_motivo_pedido_empurrado w_ge534_motivo_pedido_empurrado
...
on w_ge534_motivo_pedido_empurrado.create
call super::create
end on

on w_ge534_motivo_pedido_empurrado.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_visual from dc_w_cadastro_lista`dw_visual within w_ge534_motivo_pedido_empurrado
end type

type gb_aux_visual from dc_w_cadastro_lista`gb_aux_visual within w_ge534_motivo_pedido_empurrado
end type

type dw_1 from dc_w_cadastro_lista`dw_1 within w_ge534_motivo_pedido_empurrado
integer width = 1765
...
//	ls_Motivo_Empurrado = dw_1.Object.De_Motivo_Empurrado [ll_Linha]
//	If ls_Motivo_Empurrado = '' Or IsNull(ls_Motivo_Empurrado) Then
//		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o!", "Motivo n$$HEX1$$e300$$ENDHEX$$o pode ser vazio. ", Exclamation!)
//		dw_1.Event ue_Pos(ll_Linha,"de_motivo_empurrado") 
//		Return -1
//	End if
//Next 
//
...
type gb_1 from dc_w_cadastro_lista`gb_1 within w_ge534_motivo_pedido_empurrado
integer width = 1838
end type
