HA$PBExportHeader$uo_ge538_json.sru
forward
global type uo_ge538_json from internetresult
end type
type json_pair from structure within uo_ge538_json
end type
type jsonparser_state from structure within uo_ge538_json
end type
end forward
...
global uo_ge538_json uo_ge538_json
...
public subroutine setobject (readonly uo_ge538_json object)
...
public function uo_ge538_json getobject ()
...
public function any getobjectattribute (uo_ge538_json object, string as_name)
private function boolean retrieve (readonly any value, string path, ref any value_out)
public function boolean isobjectattributepresent (readonly uo_ge538_json object, readonly string as_name)
...
public subroutine setobject (readonly uo_ge538_json object);ia_value = object
end subroutine
...
public function boolean isobject (any value);return classname(value)='uo_ge538_json'
end function
...
public function uo_ge538_json getobject ();return ia_value
end function
...
public function any getobjectattribute (uo_ge538_json object, string as_name);return object.getAttribute(as_name)
end function
...
public function boolean isobjectattributepresent (readonly uo_ge538_json object, readonly string as_name);return object.isAttibutePresent(as_name)
end function
		...
		case STATE_VAL
			choose case c
				case '{'
					...
					states[sidx].obj = create uo_ge538_json
...
on uo_ge538_json.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_ge538_json.destroy
