HA$PBExportHeader$uo_ge546_distribuidora_historico.sru
forward
global type uo_ge546_distribuidora_historico from nonvisualobject
end type
end forward

global type uo_ge546_distribuidora_historico from nonvisualobject
end type
global uo_ge546_distribuidora_historico uo_ge546_distribuidora_historico
...
public function boolean of_grava_log (integer ai_arquivo, string as_mensagem, boolean ab_envia);return gf_grava_log_basico_email(ai_arquivo, as_mensagem, ab_envia, 51)

end function

on uo_ge546_distribuidora_historico.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_ge546_distribuidora_historico.destroy
