HA$PBExportHeader$uo_ge609_cancela_pedido_urgente.sru
forward
global type uo_ge609_cancela_pedido_urgente from nonvisualobject
end type
end forward

global type uo_ge609_cancela_pedido_urgente from nonvisualobject
end type
global uo_ge609_cancela_pedido_urgente uo_ge609_cancela_pedido_urgente
...
If SqlCa.SqlCode = -1 Then
	gf_ge202_envia_email_automatico(76, '', "Erro ao cancelar os pedidos urgentes. uo_gn011_cancela_pedido_urgente.of_cancela_pedido_urgente_pendente(). " + SqlCa.SqlErrText, {''} )
	SqlCa.of_Rollback();
	Return False
End If
...
on uo_ge609_cancela_pedido_urgente.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_ge609_cancela_pedido_urgente.destroy
