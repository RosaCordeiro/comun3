HA$PBExportHeader$uo_ge614_nfe_envia_email_destinatario.sru
forward
global type uo_ge614_nfe_envia_email_destinatario from nonvisualobject
end type
end forward

global type uo_ge614_nfe_envia_email_destinatario from nonvisualobject
end type
global uo_ge614_nfe_envia_email_destinatario uo_ge614_nfe_envia_email_destinatario
...
Try
	Try
		...
		If Not lds_Notas.of_ChangeDataObject("ds_GE614_notas_pendente_envio_email") Then
			MessageBox("Erro", "Erro no ChageDataObject da ds_GE614_notas_pendente_envio_email.")
			Return
		End If
		...
		If ll_Linhas < 0 Then
			MessageBox("Erro", "Erro no Retrieve da ds_GE614_notas_pendente_envio_email.")
			Return
		End If
...
Try
	...
	If Not gf_ge202_envia_email_padrao(268, str) Then
		MessageBox("Erro", "Erro ao enviar e-mail de log na fun$$HEX2$$e700e300$$ENDHEX$$o 'of_envia_email_erro_processamento' da 'GE614'.", StopSign!)	
	End If
Catch	( runtimeerror  lo_rte)	
...
on uo_ge614_nfe_envia_email_destinatario.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_ge614_nfe_envia_email_destinatario.destroy
