HA$PBExportHeader$w_ge658_cadastro_param_libera_senha.srw
forward
global type w_ge658_cadastro_param_libera_senha from dc_w_cadastro_selecao_lista
end type
end forward

global type w_ge658_cadastro_param_libera_senha from dc_w_cadastro_selecao_lista
string tag = "w_ge658_cadastro_param_libera_senha"
integer width = 2779
integer height = 1904
string title = "GE658 - Cadastro de Par$$HEX1$$e200$$ENDHEX$$metros - Libera Senha Conv$$HEX1$$ea00$$ENDHEX$$nio"
end type
global w_ge658_cadastro_param_libera_senha w_ge658_cadastro_param_libera_senha
...
on w_ge658_cadastro_param_libera_senha.create
call super::create
end on

on w_ge658_cadastro_param_libera_senha.destroy
call super::destroy
...
For ll_Linha = 1 To dw_2.RowCount()
	...
	If gf_Houve_Alteracao_Dw(dw_2, 'liberado_disp_senha', ll_Linha, Ref ls_Para) Then
            If Not wf_Atualiza_Parametro_Central('ID_DISPENSA_SENHA_CONVENIO_VENDA_ADM', ll_Filial, ls_Para) Then Return -1
        End If
...
type dw_visual from dc_w_cadastro_selecao_lista`dw_visual within w_ge658_cadastro_param_libera_senha
integer x = 37
integer y = 1216
end type

type gb_aux_visual from dc_w_cadastro_selecao_lista`gb_aux_visual within w_ge658_cadastro_param_libera_senha
integer x = 0
integer y = 1144
end type

type dw_1 from dc_w_cadastro_selecao_lista`dw_1 within w_ge658_cadastro_param_libera_senha
integer width = 1728
integer height = 84
string dataobject = "dw_ge658_selecao"
end type
...
type gb_2 from dc_w_cadastro_selecao_lista`gb_2 within w_ge658_cadastro_param_libera_senha
integer y = 216
integer width = 2665
integer height = 1468
end type

type gb_1 from dc_w_cadastro_selecao_lista`gb_1 within w_ge658_cadastro_param_libera_senha
integer width = 1797
integer height = 192
end type

type dw_2 from dc_w_cadastro_selecao_lista`dw_2 within w_ge658_cadastro_param_libera_senha
integer y = 292
integer width = 2569
integer height = 1352
string dataobject = "dw_ge658_lista"
end type
...
If Not IsNull(ll_Filial) And ll_Filial > 0 Then
	This.of_AppendWhere_SubQuery("f.cd_filial = " + String(ll_Filial), 2)
End If
...
event dw_2::itemchanged;call super::itemchanged;If dwo.Name = "liberado_disp_senha"  Then
	dw_1.Enabled = False
	ib_Alterando = True
End If
end event
