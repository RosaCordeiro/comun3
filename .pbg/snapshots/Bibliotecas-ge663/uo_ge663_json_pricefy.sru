HA$PBExportHeader$uo_ge663_json_pricefy.sru
forward
global type uo_ge663_json_pricefy from internetresult
end type
type json_pair from structure within uo_ge663_json_pricefy
end type
type jsonparser_state from structure within uo_ge663_json_pricefy
end type
end forward
...
global uo_ge663_json_pricefy uo_ge663_json_pricefy
...
public subroutine setobject (readonly uo_ge040_json object)
...
public function uo_ge040_json getobject ()
...
public function any getobjectattribute (uo_ge040_json object, string as_name)
private function boolean retrieve (readonly any value, string path, ref any value_out)
public function boolean isobjectattributepresent (readonly uo_ge040_json object, readonly string as_name)
...
public subroutine setattribute (readonly string as_name, readonly any aa_value, readonly string as_str_fmt)
...
public subroutine setattribute (readonly string as_name, readonly any aa_value);setattribute( as_name, aa_value, "[general]")
end subroutine
...
public subroutine setobject (readonly uo_ge040_json object);ia_value = object
end subroutine
...
public function boolean isobject (any value);return classname(value)='uo_ge040_json'
end function
...
public function uo_ge040_json getobject ();return ia_value
end function
...
public function any getobjectattribute (uo_ge040_json object, string as_name);return object.getAttribute(as_name)
end function
...
public function boolean isobjectattributepresent (readonly uo_ge040_json object, readonly string as_name);return object.isAttibutePresent(as_name)
end function
		...
		case STATE_VAL
			choose case c
				case '{'
					...
					states[sidx].obj = create uo_ge040_json
...
public subroutine setattribute (readonly string as_name, readonly any aa_value, readonly string as_str_fmt);long index
index = findpairindex(as_name)
if index < 1 then
...
choose case true
	case isnull(aa_value), isarray(aa_value), isobject(aa_value), isbool(aa_value), isnumber(aa_value)
...
on uo_ge663_json_pricefy.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_ge663_json_pricefy.destroy
