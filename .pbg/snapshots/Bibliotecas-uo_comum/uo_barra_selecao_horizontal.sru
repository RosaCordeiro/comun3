HA$PBExportHeader$uo_barra_selecao_horizontal.sru
forward
global type uo_barra_selecao_horizontal from UserObject
end type
type cb_seleciona_um from commandbutton within uo_barra_selecao_horizontal
end type
type cb_seleciona_todos from commandbutton within uo_barra_selecao_horizontal
end type
type cb_deseleciona_todos from commandbutton within uo_barra_selecao_horizontal
end type
type cb_deseleciona_um from commandbutton within uo_barra_selecao_horizontal
end type
end forward
...
global uo_barra_selecao_horizontal uo_barra_selecao_horizontal
...
on uo_barra_selecao_horizontal.create
...
on uo_barra_selecao_horizontal.destroy
